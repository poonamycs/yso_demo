					...
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Utilities</h4><span
								class="text-muted mt-1 tx-13 ms-2 mb-0">/ Border</span>
						</div>
					</div>
							...
							<div class="card-body">
								...
								<div class="row">
									<div class="col-md-6 col-xl-3 col-md-4">
										...
										<div class="p-3 p-3 bg-gray-100 bd-l bd-2 mt-4 mb-4 mb-xl-0">.border-start</div>
									</div>
									<div class="col-md-6 col-xl-3 col-md-4">
										<div class="p-3 p-3 bg-gray-100 bd-t bd-2 ">.border-top</div>
										<div class="p-3 p-3 bg-gray-100 bd-y bd-2 mt-4 mb-4 mb-xl-0">.border-top &
											.border-bottom</div>
									</div>
									<div class="col-md-6 col-xl-3 col-md-4">
										<div class="p-3 p-3 bg-gray-100 bd-r bd-2">.border-end</div>
										<div class="p-3 p-3 bg-gray-100 bd-x bd-2 mt-4 mb-4 mb-xl-0">.border-start &
											.border-end</div>
									</div>
									<div class="col-md-6 col-xl-3 col-md-4">
