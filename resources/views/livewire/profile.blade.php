...
@section('content')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<span class="text-muted mt-1 tx-13 ms-2 mb-0">Dashboard </span>
							...
							<div class="card-body">
								<div class="ps-0">
									<div class="main-profile-overview">
										<div class="main-img-user1 profile-user">
											<!-- <img alt="" src="{{asset('assets/img/faces/6.jpg')}}"> -->
											@if(Auth::guard('admin')->User()->image)
											<img src="{{asset('assets/img/user/'.Auth::guard('admin')->User()->image)}}" />
											@else
											<div class="avatar ht-100 wd-100 avatar-xxl bg-info"> {{mb_substr(ucfirst(Auth::guard('admin')->User()->name) , 0, 1)}} </div>
											@endif
										...
										<div class="d-flex justify-content-between mg-b-20 mt-2">
											<div>
												...
												<p class="main-profile-name-text fw-500 tx-15"><i class="fa fa-envelope"></i> {{Auth::guard('admin')->User()->email}}</p>
												@if(Auth::guard('admin')->User()->admin_role == 'Superadmin')
												<p class="main-profile-name-text fw-500 tx-15"><i class="fa fa-user-check"></i> {{ Auth::guard('admin')->User()->admin_role }}</p>
												@else
												<p class="main-profile-name-text fw-500 tx-15"><i class="fa fa-user-check"></i> @php $role = App\Models\Admin::select('roles.name')->join('roles','admins.role_id','roles.id')->where('admins.role_id',Auth::id())->first(); echo $role->name; @endphp</p>
												@endif
											</div>
										</div>
										<!-- <h6>Bio</h6>
							...
							<div class="card-body">
								<div class="tabs-menu ">
									<ul class="nav nav-tabs profile navtab-custom panel-tabs">
										<li class="">
											<a href="#home" data-bs-toggle="tab" aria-expanded="true" class="active"> <span class="visible-xs"><i class="las la-user-circle tx-16 me-1"></i></span> <span class="hidden-xs">ABOUT ME</span> </a>
										</li>
										<li class="">
											<a href="#profile" data-bs-toggle="tab" aria-expanded="false"> <span class="visible-xs"><i class="las la-images tx-15 me-1"></i></span><span class="hidden-xs">GALLERY</span> </a>
										</li>
										<li class="">
											<a href="#settings" data-bs-toggle="tab" aria-expanded="false"> <span class="visible-xs"><i class="las la-cog tx-16 me-1"></i></span><span class="hidden-xs">SETTINGS</span> </a>
										</li>
									</ul>
								</div>
									...
									<div class="tab-pane" id="profile">
										<div class="row">
											<div class="col-sm-4">
												<div class="border p-1 card thumb">
													<a href="#" class="image-popup" title="Screenshot-2"> <img
															src="{{asset('assets/img/photos/7.jpg')}}" class="thumb-img"
											...
											<div class="col-sm-4">
												<div class=" border p-1 card thumb">
													<a href="#" class="image-popup" title="Screenshot-2"> <img
															src="{{asset('assets/img/photos/8.jpg')}}" class="thumb-img"
															alt="work-thumbnail"> </a>
													<h4 class="text-center tx-14 mt-3 mb-0">Gallary Image</h4>
													<div class="ga-border"></div>
													<p class="text-muted text-center"><small>Photography</small></p>
											...
											<div class="col-sm-4">
												<div class=" border p-1 card thumb  mb-xl-0">
													<a href="#" class="image-popup" title="Screenshot-2"> <img
															src="{{asset('assets/img/photos/10.jpg')}}" class="thumb-img"
															alt="work-thumbnail"> </a>
													<h4 class="text-center tx-14 mt-3 mb-0">Gallary Image</h4>
													<div class="ga-border"></div>
													<p class="text-muted text-center"><small>Photography</small></p>
											...
											<div class="col-sm-4">
												<div class=" border p-1 card thumb  mb-xl-0">
													<a href="#" class="image-popup" title="Screenshot-2"> <img
															src="{{asset('assets/img/photos/6.jpg')}}" class="thumb-img"
															alt="work-thumbnail"> </a>
													<h4 class="text-center tx-14 mt-3 mb-0">Gallary Image</h4>
													<div class="ga-border"></div>
													<p class="text-muted text-center"><small>Photography</small></p>
											...
											<div class="col-sm-4">
												<div class=" border p-1 card thumb  mb-xl-0">
													<a href="#" class="image-popup" title="Screenshot-2"> <img
															src="{{asset('assets/img/photos/5.jpg')}}" class="thumb-img"
															alt="work-thumbnail"> </a>
													<h4 class="text-center tx-14 mt-3 mb-0">Gallary Image</h4>
													<div class="ga-border"></div>
													<p class="text-muted text-center"><small>Photography</small></p>
