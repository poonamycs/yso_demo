					...
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Elements</h4><span
								class="text-muted mt-1 tx-13 ms-2 mb-0">/ Spinner</span>
						</div>
					</div>
							...
							<div class="card-body">
								...
								<div class="text-wrap">
									...
									<figure class="highlight clip-widget" id="spinner01">
										<pre><code class="language-markup"><script type="html-dashlead/script"><div class="spinner-border" role="status">
		<span class="sr-only">Loading...</span>
	</div></script></code></pre>
										<div class="clipboard-icon" data-clipboard-target="#spinner01"><i
							...
							<div class="card-body">
								...
								<div class="text-wrap">
									...
									<figure class="highlight clip-widget" id="spinner02">
										<pre><code class="language-markup"><script type="html-dashlead/script"><div>
		<div class="spinner-border text-primary" role="status">
			<span class="sr-only">Loading...</span>
		</div>
		<div class="spinner-border text-secondary" role="status">
							...
							<div class="card-body">
								...
								<div class="text-wrap">
									...
									<figure class="highlight clip-widget" id="spinner03">
										<pre><code class="language-markup"><script type="html-dashlead/script"><div class="spinner-grow" role="status">
		<span class="sr-only">Loading...</span>
	</div></script></code></pre>
							...
							<div class="card-body">
								...
								<div class="text-wrap">
									...
									<figure class="highlight clip-widget" id="spinner04">
										<pre><code class="language-markup"><script type="html-dashlead/script"><div class="spinner-grow text-primary" role="status">
		<span class="sr-only">Loading...</span>
	</div>
	<div class="spinner-grow text-secondary" role="status">
		<span class="sr-only">Loading...</span>
							...
							<div class="card-body">
								...
								<div class="text-wrap">
									...
									<figure class="highlight clip-widget" id="spinner05">
										<pre><code class="language-markup"><script type="html-dashlead/script"><div class="text-center mg-b-20">
		<div class="spinner-border" role="status">
			<span class="sr-only">Loading...</span>
		</div>
	</div>
							...
							<div class="card-body">
								...
								<div class="text-wrap">
									...
									<figure class="highlight clip-widget" id="spinner06">
										<pre><code class="language-markup"><script type="html-dashlead/script"><div class="spinner-border spinner-border-sm" role="status">
		<span class="sr-only">Loading...</span>
	</div>
	<div class="spinner-grow spinner-grow-sm" role="status">
		<span class="sr-only">Loading...</span>
							...
							<div class="card-body">
								...
								<div class="text-wrap">
									...
									<figure class="highlight clip-widget" id="spinner07">
										<pre><code class="language-markup"><script type="html-dashlead/script"><button class="btn btn-primary" type="button" disabled>
