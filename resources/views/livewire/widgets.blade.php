...
@section('content')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Widgets</h4><span
								class="text-muted mt-1 tx-13 ms-2 mb-0">/ Widgets</span>
						</div>
					</div>
							...
							<div class="card-body list-icons">
								...
								<div class="card-footer p-0">
									<p class="text-muted mb-0 pt-4"><i
											class="si si-arrow-down-circle text-warning me-1-20  me-2"
					...
					<div class="col-sm-12 col-lg-6 col-xl-3">
						<div class="card card-img-holder">
							<div class="card-body list-icons">
								...
								<div class="card-footer p-0">
									<p class="text-muted mb-0 pt-4"><i
											class="si si-arrow-up-circle text-success me-2"></i>Less Sales</p>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-sm-12 col-lg-6">
						<div class="card">
							<div class="card-header pb-0">
								...
								<p class="tx-12 tx-gray-500 mb-3">On the other hand, we denounce with right indignation
									and dislike imagesralized <a href="">Learn more</a></p>
							</div>
							<div class="card-body">
								<div class="row">
									<div class="col text-center">
										<label class="tx-12">Today</label>
										<p class="fw-bold tx-20">3,256</p>
									</div><!-- col -->
									<div class="col border-start text-center">
										<label class="tx-12">This Week</label>
										<p class="fw-bold tx-20">25,321</p>
									</div><!-- col -->
									<div class="col border-start text-center">
										<label class="tx-12">This Month</label>
										<p class="fw-bold tx-20">53,625</p>
									</div><!-- col -->
								</div><!-- row -->
								<div class="progress ht-20 mt-4">
									<div
										class="progress-bar progress-bar-striped progress-bar-animated bg-primary ht-20 w-50">
										50%</div>
								</div>
							</div>
						</div>
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="row">
									<div class="col text-center">
										<label class="tx-12">Today</label>
										<p class="fw-bold tx-20">236 $</p>
									</div><!-- col -->
									<div class="col border-start text-center ">
										<label class="tx-12">This Week</label>
										<p class="fw-bold tx-20">1,365 $</p>
									</div><!-- col -->
									<div class="col border-start text-center">
										<label class="tx-12">This Month</label>
										<p class="fw-bold tx-20">36,254 $</p>
									</div><!-- col -->
								</div><!-- row -->
								<div class="progress mt-4 ht-20">
									<div
										class="progress-bar progress-bar-striped progress-bar-animated bg-warning wd-60p ht-20">
										36%</div>
								</div>
							</div>
						</div>
								...
								<div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
									...
									<div class="carousel-inner">
										<div class="carousel-item active flex-column">
											...
											<h3 class="text-white font-light">Now Get <span class="font-bold">20%
										...
										<div class="carousel-item flex-column">
											...
											<h3 class="text-white font-light">Now Get <span class="font-bold">60%
													Off</span><br> on buy</h3>
											<div class="text-white m-t-20">
												<i>- Joseph Vaughan</i>
											</div>
										...
										<div class="carousel-item flex-column">
											...
											<h3 class="text-white font-light">Now Get <span class="font-bold">90%
													Off</span><br> on buy</h3>
											<div class="text-white m-t-20">
												<i>- Alan Hemmings</i>
											</div>
								...
								<div id="myCarousel0" class="carousel slide" data-bs-ride="carousel">
									...
									<div class="carousel-inner">
										<div class="carousel-item active flex-column">
											...
											<h3 class="text-white font-light">Now Get <span class="font-bold">30%
													Off</span><br>on buy</h3>
											<div class="text-white m-t-20">
												<i>- Alan Hemmings</i>
											</div>
										...
										<div class="carousel-item flex-column">
											...
											<h3 class="text-white font-light">Now Get <span class="font-bold">70%
													Off</span><br> on buy</h3>
											<div class="text-white m-t-20">
												<i>- Eric Lee</i>
											</div>
										...
										<div class="carousel-item flex-column">
											...
											<h3 class="text-white font-light">Now Get <span class="font-bold">80%
													Off</span><br> on buy</h3>
											<div class="text-white m-t-20">
												<i>- Eric Lee</i>
											</div>
						...
						<div class="card">
							<div class="card-body iconfont text-start">
								...
								<div class="d-flex mb-0">
									<div class="">
										<h4 class="mb-1 fw-bold">154<span
												class="text-success tx-13 ms-2">(+0.98%)</span></h4>
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
						<div class="card">
							<div class="card-body iconfont text-start">
								...
								<div class="d-flex mb-0">
									<div class="">
										<h4 class="mb-1 fw-bold">5274<span
												class="text-danger tx-13 ms-2">(-12.45%)</span></h4>
										<p class="mb-2 tx-12 text-muted">Overview of Last month</p>
									</div>
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
						<div class="card">
							<div class="card-body iconfont text-start">
								...
								<div class="d-flex mb-0">
									<div class="">
										<h4 class="mb-1   fw-bold">76.3%<span
								...
								<small class="mb-0  text-muted">Monthly<span
										class="float-end text-muted">60%</span></small>
							</div>
						</div>
					</div>
					<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
						<div class="card">
							<div class="card-body iconfont text-start">
								...
								<div class="d-flex mb-0">
									<div class="">
										<h4 class="mb-1 fw-bold">5m 24s<span
												class="text-success tx-13 ms-2">(+19.5%)</span></h4>
										<p class="mb-2 tx-12 text-muted">Overview of Last month</p>
									</div>
								...
								<small class="mb-0  text-muted">Monthly<span
										class="float-end text-muted">40%</span></small>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="card">
							<div class="card-body">
								<div class="card-order">
									...
									<h2 class="text-end "><i
											class="mdi mdi-account-multiple icon-size float-start text-primary text-primary-shadow"></i><span>3,672</span>
									</h2>
						...
						<div class="card ">
							<div class="card-body">
								<div class="card-widget">
									...
									<h2 class="text-end"><i
											class="mdi mdi-cube icon-size float-start text-success text-success-shadow"></i><span>$89,265</span>
									</h2>
						...
						<div class="card">
							<div class="card-body">
								<div class="card-widget">
									...
									<h2 class="text-end"><i
											class="icon-size mdi mdi-poll-box   float-start text-warning text-warning-shadow"></i><span>$23,987</span>
									</h2>
						...
						<div class="card ">
							<div class="card-body">
								<div class="card-widget">
									...
									<h2 class="text-end"><i
											class="fa fa-cart-plus icon-size float-start text-danger text-danger-shadow"></i><span>46,486</span>
									</h2>
							...
							<div class="card-body">
								<div class="row">
									<div class="col">
										...
										<div class="h3 mt-2 mb-2"><b>19.89K</b><span
												class="text-success tx-13 ms-2">(+25%)</span></div>
									</div>
					...
					<div class="col-xl-3 col-lg-6 col-sm-6 col-md-6">
						<div class="card text-center">
							<div class="card-body ">
								...
								<h3 class="fw-semibold">$125.465</h3>
							</div>
						</div>
					</div>
					<div class="col-xl-3 col-lg-6 col-sm-6 col-md-6">
						<div class="card text-center">
							<div class="card-body ">
								...
								<h3 class="fw-semibold">$75.045</h3>
							</div>
						</div>
					</div>
					<div class="col-xl-3 col-lg-6 col-sm-6 col-md-6">
						...
						<div class="card">
							<div class="card-body">
								<div class="plan-card text-center">
									...
									<span class="badge bg-danger"> +76% </span>
									<span class="text-muted">From previous month</span>
								</div>
							</div>
						</div>
					...
					<div class="col-md-12 col-xl-4">
						<div class="card">
							<div class="card-body">
								...
								<div class="list d-flex align-items-center border-bottom py-3">
									<div class="avatar brround d-block cover-image"
										data-bs-image-src="{{asset('assets/img/faces/1.jpg')}}">
										<span class="avatar-status bg-green"></span>
									</div>
									<div class="wrapper w-100 ms-3">
										<p class="mb-0">
								...
								<div class="list d-flex align-items-center border-bottom py-3">
									<div class="avatar brround d-block cover-image"
										data-bs-image-src="{{asset('assets/img/faces/14.jp')}}g">
										<span class="avatar-status bg-green"></span>
									</div>
									<div class="wrapper w-100 ms-3">
										<p class="mb-0">
								...
								<div class="list d-flex align-items-center pt-3">
									<div class="avatar brround d-block cover-image"
										data-bs-image-src="{{asset('assets/img/faces/4.jpg')}}">
										<span class="avatar-status bg-green"></span>
									</div>
									<div class="wrapper w-100 ms-3">
										<p class="mb-0">
					...
					<div class="col-md-12 col-xl-4">
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Business Team</h3>
							</div>
							<div class="card-body">
								<div>
									<div class="chips">
										<div class="team">
											<a href="javascript:void(0)" class="chip">
												<span class="avatar cover-image"
													data-bs-image-src="{{asset('assets/img/faces/2.jpg')}}"></span> Victoria
											</a>
										...
										<div class="team">
											<a href="javascript:void(0)" class="chip">
												<span class="avatar cover-image"
													data-bs-image-src="{{asset('assets/img/faces/3.jpg')}}"></span> Nathan
											</a>
											<i class="fab fa-facebook text-primary" aria-hidden="true"></i>
											<i class="fab fa-twitter text-primary" aria-hidden="true"></i>
											<i class="fas fa-envelope text-primary" aria-hidden="true"></i>
										...
										<div class="team">
											<a href="javascript:void(0)" class="chip">
												<span class="avatar cover-image"
													data-bs-image-src="{{asset('assets/img/faces/4.jpg')}}"></span> Alice
											</a>
											<i class="fab fa-facebook text-primary" aria-hidden="true"></i>
											<i class="fab fa-twitter text-primary" aria-hidden="true"></i>
											<i class="fas fa-envelope text-primary" aria-hidden="true"></i>
											<p class="mb-0">On the other hand, we denounce with right indignation and
						...
						<div class="card">
							...
							<div class="card-body p-0">
								<table class="table card-table country-table mb-0">
									<tbody>
										<tr>
											<td class="w-1"><img src="{{asset('assets/img/flags/us_flag.jpg')}}" alt="flags"
													class="flag wd-30 ht-20 flag-us mt-1"></i></td>
											<td>USA
										...
										<tr>
											<td class="w-1"><img src="{{asset('assets/img/flags/spain_flag.jpg')}}" alt="flags"
													class="flag wd-30 ht-20 flag-us mt-1"></i></td>
											<td>Spain
												<div class="progress progress-sm mt-1">
										...
										<tr>
											<td class="w-1"><img src="{{asset('assets/img/flags/germany_flag.jpg')}}"
										...
										<tr>
											<td class="w-1"><img src="{{asset('assets/img/flags/russia_flag.jpg')}}"
													alt="flags" class="flag wd-30 ht-20 flag-us mt-1"></i></td>
											<td>Russia
												<div class="progress progress-sm mt-1">
										...
										<tr>
											<td class="w-1"><img src="{{asset('assets/img/flags/italy_flag.jpg')}}" alt="flags"
													class="flag wd-30 ht-20 flag-us mt-1"></i></td>
											<td>Italy
												<div class="progress progress-sm mt-1">
										...
										<tr>
											<td class="w-1"><img src="{{asset('assets/img/flags/french_flag.jpg')}}"
													alt="flags" class="flag wd-30 ht-20 flag-us mt-1"></i></td>
											<td>French
												<div class="progress progress-sm mt-1">
													<div class="progress-bar bg-teal wd-40"></div>
				...
				<div class="row row-sm">
					<div class="col-xl-4 col-lg-6 col-md-12 col-sm-12">
						<div class="card">
							<div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
								...
								<p class="tx-12 tx-gray-500 mb-0">Opinion of a customer on the product in the form of
									ratings 5-star rating. <a href="">Learn more</a></p>
							</div><!-- card-header -->
							<div class="card-body pd-y-7">
								...
								<h6 class="tx-uppercase tx-spacing-1 tx-semibold tx-10 tx-color-02 mg-b-15">Overall
								...
								<table class="table table-borderless mt-3 rating-table">
									<tbody>
										<tr>
											...
											<td class="text-gray"><span><i
														class="ion ion-md-star tx-18 text-warning"></i></span></td>
											<td class="w-100">
								...
								<div class="wrapper d-flex justify-content-center image-group pb-3">
									...
									<img src="{{asset('assets/img/faces/13.jpg')}}" alt="profile"
										class="img-xs rounded-circle">
									<img src="{{asset('assets/img/faces/14.jpg')}}" alt="profile"
										class="img-xs rounded-circle">
									<img src="{{asset('assets/img/faces/5.jpg')}}" alt="profile" class="img-xs rounded-circle">
									<img src="{{asset('assets/img/faces/16.jpg')}}" alt="profile"
										class="img-xs rounded-circle">
								</div>
							</div><!-- card-body -->
						</div>
					...
					<div class="col-xl-4 col-lg-6 col-md-12 col-sm-12">
						<div class="card order-list">
							<div class="card-body">
								...
								<p class="tx-12 tx-gray-500 mb-3">Order Activity is ecommerce platforms to track the
									orders placed on their stores <a href="">Learn more</a></p>
								<ul class="list list-noborders pb-0 mb-0">
									<li class="list-item">
										<img class="img-sm rounded-circle bg-warning d-flex align-items-center justify-content-center text-white"
											src="{{asset('assets/img/faces/3.jpg')}}" alt="Profile Image">
										<div class=" ms-3">
											<h6 class="mb-1 fw-medium">Lottie Arnold</h6>
											<p class="mb-0 text-muted tx-13">#PRD-10250</p>
										</div>
										<div class="ms-auto d-flex">
											<img class="img-sm me-1" src="{{asset('assets/img/ecommerce/03.jpg')}}"
												alt="thumb images">
											<img class="img-sm" src="{{asset('assets/img/ecommerce/08.jpg')}}"
												alt="thumb images">
										</div>
									</li>
									<li class="list-item">
										<img class="img-sm rounded-circle bg-warning d-flex align-items-center justify-content-center text-white"
											src="{{asset('assets/img/faces/9.jpg')}}" alt="Profile Image">
										<div class=" ms-3">
											<h6 class="mb-1 fw-medium">Alan Macedo</h6>
											<p class="mb-0 tx-13 text-muted">#PRD-10251</p>
										</div>
										<div class="ms-auto d-flex">
											<img class="img-sm me-1" src="{{asset('assets/img/ecommerce/04.jpg')}}"
												alt="thumb images">
											<img class="img-sm" src="{{asset('assets/img/ecommerce/05.jpg')}}"
												alt="thumb images">
										</div>
									</li>
									<li class="list-item">
										<img class="img-sm rounded-circle bg-warning d-flex align-items-center justify-content-center text-white"
											src="{{asset('assets/img/faces/5.jpg')}}" alt="Profile Image">
										<div class=" ms-3">
											<h6 class="mb-1 fw-medium">Bruce Tran</h6>
											<p class="mb-0 text-muted tx-13">#PRD-10252</p>
										</div>
										<div class="ms-auto d-flex">
											<img class="img-sm me-1" src="{{asset('assets/img/ecommerce/06.jpg')}}"
												alt="thumb images">
											<img class="img-sm" src="{{asset('assets/img/ecommerce/07.jpg')}}"
												alt="thumb images">
										</div>
									</li>
									<li class="list-item">
										<img class="img-sm rounded-circle bg-warning d-flex align-items-center justify-content-center text-white"
											src="{{asset('assets/img/faces/12.jpg')}}" alt="Profile Image">
										<div class=" ms-3">
											<h6 class="mb-1 fw-medium">Mina Harper</h6>
											<p class="mb-0 text-muted tx-13">#PRD-10253</p>
										</div>
										<div class="ms-auto d-flex">
											<img class="img-sm me-1" src="{{asset('assets/img/ecommerce/08.jpg')}}"
												alt="thumb images">
											<img class="img-sm" src="{{asset('assets/img/ecommerce/09.jpg')}}"
												alt="thumb images">
										</div>
									</li>
									<li class="list-item pb-0 mb-0">
										<img class="img-sm rounded-circle bg-warning d-flex align-items-center justify-content-center text-white"
											src="{{asset('assets/img/faces/8.jpg')}}" alt="Profile Image">
										<div class=" ms-3">
											<h6 class="mb-1 fw-medium">Maria Quinn</h6>
											<p class="mb-0 text-muted tx-13">#PRD-10254</p>
										</div>
										<div class="ms-auto d-flex">
											<img class="img-sm me-1" src="{{asset('assets/img/ecommerce/02.jpg')}}"
												alt="thumb images">
											<img class="img-sm" src="{{asset('assets/img/ecommerce/01.jpg')}}"
												alt="thumb images">
										</div>
									</li>
								</ul>
					...
					<div class="col-md-12 col-lg-6 col-xl-4 col-sm-12">
						<div class="card">
							...
							<p class="tx-12 tx-gray-500 mb-0 ps-3 pe-3">A review is an evaluation of a publication,
								service, or company .<a href="">Learn more</a></p>
							<div class="rating-scroll ps ps--active-y">
								<div class="ps-3 pe-3 py-3 border-bottom">
									<div class="media mt-0">
										...
										<div class="media-body">
											<div class="d-flex">
												<h6 class="mt-0 mb-0 fw-semibold ">Joanne Scott</h6>
								...
								<div class="ps-3 pe-3 py-3 border-bottom">
									<div class="media mt-0">
										...
										<div class="media-body">
											<div class="d-flex">
												<h6 class="mt-0 mb-0 fw-semibold ">Cristobal Sharp</h6>
												<span class="tx-12 ms-auto">
													<i class="ion ion-md-star text-warning"></i>
													<i class="ion ion-md-star text-warning"></i>
													<i class="ion ion-md-star text-warning"></i>
								...
								<div class="ps-3 pe-3 py-3 border-bottom">
									<div class="media mt-0">
										...
										<div class="media-body">
											<div class="d-flex">
												<h6 class="mt-0 mb-0 fw-semibold ">Velma Wellons </h6>
												<span class="tx-12 ms-auto">
													<i class="ion ion-md-star text-warning"></i>
													<i class="ion ion-md-star text-warning"></i>
													<i class="ion ion-md-star text-warning"></i>
								...
								<div class="ps-3 pe-3 py-3 border-bottom">
									<div class="media mt-0">
										...
										<div class="media-body">
											<div class="d-flex">
												<h6 class="mt-0 mb-0 fw-semibold ">Cathie Madonna </h6>
												<span class="tx-12 ms-auto">
													<i class="ion ion-md-star text-warning"></i>
													<i class="ion ion-md-star text-warning"></i>
													<i class="ion ion-md-star text-warning"></i>
								...
								<div class="ps-3 pe-3 py-3 border-bottom">
									<div class="media mt-0">
										...
										<div class="media-body">
											<div class="d-flex">
												<h6 class="mt-0 mb-0 fw-semibold ">Aurelio Dahmer </h6>
												<span class="tx-12 ms-auto">
													<i class="ion ion-md-star text-warning"></i>
													<i class="ion ion-md-star text-warning"></i>
													<i class="ion ion-md-star text-warning"></i>
								...
								<div class="ps-3 pe-3 py-3 border-bottom">
									<div class="media mt-0">
										...
										<div class="media-body">
											<div class="d-flex">
												<h6 class="mt-0 mb-1 fw-semibold ">Cyrus Macarthur </h6>
												<span class="tx-12 ms-auto">
													<i class="ion ion-md-star text-warning"></i>
													<i class="ion ion-md-star text-warning"></i>
													<i class="ion ion-md-star text-warning"></i>
								...
								<div class="ps-3 pe-3 py-3 border-bottom">
									<div class="media mt-0">
										...
										<div class="media-body">
											<div class="d-flex">
												<h6 class="mt-0 mb-1 fw-semibold ">Bernardo Sykes </h6>
												<span class="tx-12 ms-auto">
													<i class="ion ion-md-star text-warning"></i>
													<i class="ion ion-md-star text-warning"></i>
													<i class="ion ion-md-star text-warning"></i>
					...
					<div class="col-md-12 col-lg-6 col-xl-4">
						<div class="card">
							<div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
								...
								<p class="tx-12 tx-gray-500 mb-0">session by country mean that the user is from the
									stated country or that the session is originating in the stated country. <a
										href="">Learn more</a></p>
							</div>
							<div class="card-body">
								<ul class="sales-session mb-0">
									<li>
										<div class="d-flex justify-content-between">
											...
											<p class="fw-semibold mb-2">$273.12 <span
													class="text-muted fw-normal">(2.17%)</span></p>
										</div>
									...
									<li>
										<div class="d-flex justify-content-between">
											...
											<p class="fw-semibold mb-2">$423.10 <span
													class="text-muted fw-normal">(12.43%)</span></p>
										</div>
										<div class="progress  ht-5">
											<div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50"
									...
									<li>
										<div class="d-flex justify-content-between">
											<h6>3. Australia</h6>
											<p class="fw-semibold mb-2">$547.18 <span
													class="text-muted fw-normal">(3.14%)</span></p>
										</div>
										<div class="progress  ht-5">
									...
									<li>
										<div class="d-flex justify-content-between">
											<h6>4. Canada</h6>
											<p class="fw-semibold mb-2">$728.32 <span
													class="text-muted fw-normal">(7.23%)</span></p>
										</div>
										<div class="progress  ht-5">
											<div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50"
									...
									<li>
										<div class="d-flex justify-content-between">
											<h6>5. Russia</h6>
											<p class="fw-semibold mb-2">$843.19 <span
													class="text-muted fw-normal">(1.83%)</span></p>
										</div>
									...
									<li class="mb-0 pb-1">
										<div class="d-flex justify-content-between">
											<h6>6. Japan</h6>
											<p class="fw-semibold mb-2">$562.19 <span
													class="text-muted fw-normal">(1.35%)</span></p>
										</div>
										<div class="progress mb-0 ht-5">
											<div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50"
							...
							<div class="card-body p-0">
								<div class="browser-stats">
									<div class="d-flex align-items-center item  border-bottom">
										<div class="d-flex">
											<img src="{{asset('assets/img/svgicons/chrome.svg')}}" alt="img"
									...
									<div class="d-flex align-items-center item  border-bottom">
										<div class="d-flex">
											<img src="{{asset('assets/img/svgicons/opera.svg')}}" alt="img"
												class="ht-30 wd-30 me-2">
											<div class="">
												<h6 class="">Opera</h6>
												<span class="sub-text">Mozilla Foundation, Inc.</span>
									...
									<div class="d-flex align-items-center item  border-bottom">
										<div class="d-flex">
											<img src="{{asset('assets/img/svgicons/edge.svg')}}" alt="img"
												class="ht-30 wd-30 me-2">
											<div class="">
												<h6 class="">Edge</h6>
												<span class="sub-text">Mozilla Foundation, Inc.</span>
									...
									<div class="d-flex align-items-center item  border-bottom">
										<div class="d-flex">
											<img src="{{asset('assets/img/svgicons/firefox.svg')}}" alt="img"
												class="ht-30 wd-30 me-2">
											<div class="">
												<h6 class="">Firefox</h6>
												<span class="sub-text">Mozilla Foundation, Inc.</span>
									...
									<div class="d-flex align-items-center item border-bottom">
										<div class="d-flex">
											<img src="{{asset('assets/img/svgicons/uc-browser.svg')}}" alt="img"
												class="ht-30 wd-30 me-2">
											<div class="">
									...
									<div class="d-flex align-items-center item">
										<div class="d-flex">
											<img src="{{asset('assets/img/svgicons/safari.svg')}}" alt="img"
												class="ht-30 wd-30 me-2">
											<div class="">
												<h6 class="">Safari</h6>
												<span class="sub-text">Mozilla Foundation, Inc.</span>
