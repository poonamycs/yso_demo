...
@section('content')
					...
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Elements</h4><span
								class="text-muted mt-1 tx-13 ms-2 mb-0">/ Typography</span>
						</div>
					</div>
							...
							<div class="card-body pt-0">
								<div class="text-wrap">
									...
									<figure class="highlight clip-widget" id="typo1">
										<pre><code class="language-markup"><script type="html-Dashkit/script"><h1>h1. Heading</h1>
	<h2>h2. Heading</h2>
	<h3>h3. Heading</h3>
	<h4>h4. Heading</h4>
	<h5>h5. Heading</h5>
	<h6>h6. Heading</h6>
										...
										<div class="clipboard-icon" data-clipboard-target="#typo1"><i
							...
							<div class="card-body pt-0">
								<div class="text-wrap">
									...
									<figure class="highlight clip-widget" id="typo2">
										<pre><code class="language-markup"><script type="html-Dashkit/script"><h1 class="text-primary">h1. Heading</h1>
	<h2  class="text-secondary">h2. Heading</h2>
	<h3  class="text-success">h3. Heading</h3>
	<h4  class="text-danger">h4. Heading</h4>
	<h5  class="text-info">h5. Heading</h5>
	<h6  class="text-warning">h6. Heading</h6>
										...
										<div class="clipboard-icon" data-clipboard-target="#typo2"><i
												class="las la-clipboard"></i></div>
									</figure>
									<!-- /Prism Precode -->
								</div>
							...
							<div class="card-body pt-0">
								<div class="text-wrap">
									...
									<figure class="highlight clip-widget" id="typo3">
										<pre><code class="language-markup"><script type="html-Dashkit/script"><h1 class="heading-inverse">h1. Heading</h1>
	<h2 class="heading-inverse">h2. Heading</h2>
	<h3 class="heading-inverse">h3. Heading</h3>
	<h4 class="heading-inverse">h4. Heading</h4>
	<h5 class="heading-inverse">h5. Heading</h5>
	<h6 class="heading-inverse">h6. Heading</h6>
										...
										<div class="clipboard-icon" data-clipboard-target="#typo3"><i
												class="las la-clipboard"></i></div>
									</figure>
									<!-- End Prism Precode -->
								</div>
							...
							<div class="card-body pt-0">
								<div class="text-wrap">
									...
									<figure class="highlight clip-widget" id="typo4">
										<pre><code class="language-markup"><script type="html-Dashkit/script"><h1 class="heading-primary">h1. Heading</h1>
	<h2 class="heading-secondary">h2. Heading</h2>
	<h3 class="heading-success">h3. Heading</h3>
	<h4 class="heading-info">h4. Heading</h4>
	<h5 class="heading-warning">h5. Heading</h5>
	<h6 class="heading-danger">h6. Heading</h6>
										...
										<div class="clipboard-icon" data-clipboard-target="#typo4"><i
												class="las la-clipboard"></i></div>
									</figure>
									<!-- End Prism Precode -->
								</div>
