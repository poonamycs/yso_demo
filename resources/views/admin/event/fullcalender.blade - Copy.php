...
<div class="container">
	<div class="breadcrumb-header justify-content-between pt-3 mt-0">
		...
		<div class="main-dashboard-header-right bg-primary-transparent pl-1 pr-1 pt-2 rounded-3">
			<div>
				<label><a href="{{url('/list-view-planner')}}">List View</a></label>
			</div>
		</div>
	</div>
...
<div class="card">
    Title<input id="demo-title" type="text" name="title"/><br/>
    Time<input type="text" id="fp-time" class="form-control flatpicker-time text-start flatpicker-input active" placeholder="HH:MM"/><br/>
    Color<input id="demo-input" type="text" value="rgb(255, 128, 0)" name="color"/><br/>
    <button title="submit" class="submit-color">Submit</button>
</div>
</div>
