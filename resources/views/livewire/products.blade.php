					...
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Ecommerce</h4><span
								class="text-muted mt-1 tx-13 ms-2 mb-0">/ Products</span>
						</div>
					</div>
								...
								<div class="card">
									<div class="card-body h-100">
										<div class="pro-img-box">
											...
											<img class="w-100" src="{{asset('assets/img/ecommerce/01.jpg')}}"
												alt="product-image">
								...
								<div class="card">
									<div class="card-body h-100">
										<div class="pro-img-box">
											...
											<img class="w-100" src="{{asset('assets/img/ecommerce/02.jpg')}}"
												alt="product-image">
											<a href="#" class="adtocart"> <i class="las la-shopping-cart "></i>
											</a>
										</div>
								...
								<div class="card">
									<div class="card-body h-100">
										<div class="pro-img-box">
											...
											<img class="w-100" src="{{asset('assets/img/ecommerce/03.jpg')}}"
												alt="product-image">
											<a href="#" class="adtocart"> <i class="las la-shopping-cart "></i>
											</a>
										</div>
								...
								<div class="card">
									<div class="card-body h-100">
										<div class="pro-img-box">
											...
											<img class="w-100" src="{{asset('assets/img/ecommerce/06.jpg')}}"
												alt="product-image">
											<a href="#" class="adtocart"> <i class="las la-shopping-cart "></i>
											</a>
										</div>
								...
								<div class="card">
									<div class="card-body h-100">
										<div class="pro-img-box">
											...
											<img class="w-100" src="{{asset('assets/img/ecommerce/04.jpg')}}"
												alt="product-image">
											<a href="#" class="adtocart"> <i class="las la-shopping-cart"></i>
											</a>
										</div>
								...
								<div class="card">
									<div class="card-body h-100">
										<div class="pro-img-box">
											...
											<img class="w-100" src="{{asset('assets/img/ecommerce/05.jpg')}}"
												alt="product-image">
											<a href="#" class="adtocart"> <i class="las la-shopping-cart "></i>
											</a>
										</div>
								...
								<div class="card">
									<div class="card-body h-100">
										<div class="pro-img-box">
											...
											<img class="w-100" src="{{asset('assets/img/ecommerce/09.jpg')}}"
												alt="product-image">
											<a href="#" class="adtocart"> <i class="las la-shopping-cart "></i>
											</a>
										</div>
								...
								<div class="card">
									<div class="card-body h-100">
										<div class="pro-img-box">
											...
											<img class="w-100" src="{{asset('assets/img/ecommerce/11.jpg')}}"
												alt="product-image">
											<a href="#" class="adtocart"> <i class="las la-shopping-cart "></i>
											</a>
										</div>
								...
								<div class="card">
									<div class="card-body h-100">
										<div class="pro-img-box">
											...
											<img class="w-100" src="{{asset('assets/img/ecommerce/07.jpg')}}"
												alt="product-image">
											<a href="#" class="adtocart"> <i class="las la-shopping-cart "></i>
											</a>
										</div>
