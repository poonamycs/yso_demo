...
(() => {
	var t = {
			5927: (t, e, i) => {
				...
				var m = function () {
					...
					w = function () {
						...
						return n(t, [{
							...
							value: function (t) {
								...
								return !L || A.globals.resized || A.globals.dataChanged ? !A.globals.resized && A.globals.dataChanged || C.showDelayedElements() : C.animatePathsGradually(c(c({}, E), {}, {
									speed: g
								})), A.globals.dataChanged && P && T && C.animatePathsGradually(c(c({}, E), {}, {
									speed: u
								})), I
							}
						}, {
							...
							value: function (t, e, i) {
								...
								} else "circle" !== i.shape && i.shape || (m.isNumber(e) || (a = 0, e = 0), s = this.drawCircle(a, {
									cx: t,
									cy: e,
									class: i.class ? i.class : "",
									stroke: i.pointStrokeColor,
								...
								if (a.config.yaxis[t.yAxisIndex].logarithmic) h = (n = new S(this.annoCtx.ctx).getLogVal(n, t.yAxisIndex)) / a.globals.yLogRatio[t.yAxisIndex];
									...
									if (t.image.path) {
										...
										this.annoCtx.addImage({
											x: s + t.image.offsetX - k / 2,
											y: r + t.image.offsetY - A / 2,
											width: k,
											height: A,
											path: t.image.path,
					...
					z = function () {
						...
						return n(t, [{
							...
							value: function (t, e, i) {
								...
								} else a = t; if (s.fill.gradient.inverseColors) {
									var u = h;
									h = a, a = u
								}
					...
					Y = function () {
						...
						return n(t, [{
							...
							value: function (t) {
								...
								return v = this.barCtx.isHorizontal ? this.calculateBarsDataLabelsPosition(M) : this.calculateColumnsDataLabelsPosition(M), u.attr({
									cy: v.bcy,
									cx: v.bcx,
									j: o,
									val: l[r][o],
					...
					R = function () {
						...
						return n(t, [{
							...
							value: function (t, e, i, a) {
								...
								})), s.config.series[e].data[i] && s.config.series[e].data[i].fillColor && (o = s.config.series[e].data[i].fillColor), r.fillPath({
							...
							value: function (t, e, i, a, s) {
								var r = new w(this.barCtx.ctx),
									...
									l = Array.isArray(n);
								if (o = l ? n[a > n.length - 1 ? n.length - 1 : a] : n, t.config.chart.stacked && i.length > 1 && a !== this.barCtx.radiusOnSeriesNumber && !l && (o = 0), this.barCtx.isHorizontal) {
									var h = "",
										c = e.x2;
					...
					H = function () {
						...
						return n(t, [{
							...
							value: function (t, e) {
								...
								for (var o = 0, n = 0; o < t.length; o++, n++) {
									...
									for (var C = a.group({
										...
										this.isHorizontal ? (M = this.drawBarPaths(c(c({}, z), {}, {
											barHeight: y,
											zeroW: g,
											yDivision: h
										})), k = this.series[o][P] / this.invertedYRatio) : (M = this.drawColumnPaths(c(c({}, z), {}, {
											xDivision: l,
											barWidth: k,
											zeroH: d
										})), y = this.series[o][P] / this.yRatio[this.yaxisIndex]);
							...
							value: function (t) {
								...
								T.count > 0 && s >= S.globals.dataPoints - T.count && (P.node.setAttribute("stroke-dasharray", T.dashArray), P.node.setAttribute("stroke-width", T.strokeWidth), P.node.setAttribute("fill-opacity", T.fillOpacity)), void 0 !== g && void 0 !== u && (P.attr("data-range-y1", g), P.attr("data-range-y2", u)), new y(this.ctx).setSelectionFilter(P, e, s), h.add(P);
								var M = new Y(this).handleBarDataLabels({
									x: c,
									y: d,
									y1: g,
									y2: u,
								...
								return null !== M && m.add(M), h.add(m), v && h.add(v), h
							}
						}, {
							key: "drawBarPaths",
							value: function (t) {
									...
									for (var v = a.group({
										...
										if (g = b.yDivision, f = b.barHeight, this.isHorizontal) {
											...
											if (this.isTimelineBar && i.config.series[r].data[k].x) {
												...
												f = I.barHeight, P = I.barYPosition
											}
											x = (L = this.drawRangeBarPaths(c({
												indexes: {
													i: r,
													j: k,
													realIndex: u
										...
										} else f = (L = this.drawRangeColumnPaths(c({
											indexes: {
												i: r,
												j: k,
												realIndex: u
						...
						return n(t, [{
							...
							value: function (t) {
								var e = t.responsiveOverride,
									...
									a = new T,
									r = new O(i);
								this.chartType = i.chart.type, "histogram" === this.chartType && (i.chart.type = "bar", i = m.extend({
									plotOptions: {
										bar: {
											columnWidth: "99.99%"
										}
					...
					G = function () {
						function t(e) {
							r(this, t), this.ctx = e, this.w = e.w, this.twoDSeries = [], this.threeDSeries = [], this.twoDSeriesX = [], this.seriesGoals = [], this.coreUtils = new S(this.ctx)
						}
						return n(t, [{
							key: "isMultiFormat",
							value: function () {
							...
							value: function (t) {
								...
								}))), e.xaxis.convertedCatToNumeric && (new O(e).convertCatToNumericXaxis(e, this.ctx, i.seriesX[0]), this._generateExternalLabels(t))) : this._generateExternalLabels(t)
							}
						}, {
					...
					_ = function () {
						...
						return n(t, [{
							...
							value: function (t, e, i) {
								var a = this.w;
								return m.isNumber(t) && (t = 0 !== a.globals.yValueDecimal ? t.toFixed(void 0 !== e.decimalsInFloat ? e.decimalsInFloat : a.globals.yValueDecimal) : a.globals.maxYArr[i] - a.globals.minYArr[i] < 5 ? t.toFixed(1) : t.toFixed(0)), t
							}
						}, {
										...
										if (n.length && 0 === e && l.push(n.join(a)), t.data && t.data.length)
											for (var s = 0; s < t.data.length; s++) {
												...
												if (r || (c.isFormatXY() ? r = i[e].data[s].x : c.isFormat2DArray() && (r = i[e].data[s] ? i[e].data[s][0] : "")), 0 === e) {
													n.push((d = r, "datetime" === o.config.xaxis.type && String(d).length >= 10 ? o.config.chart.toolbar.export.csv.dateFormatter(r) : m.isNumber(r) ? r : r.split(a).join("")));
						...
						return n(t, [{
							...
							value: function (t) {
								...
								if (i.config.grid.xaxis.lines.show || i.config.xaxis.axisTicks.show)
									...
									}), new q(this.ctx).drawXaxisTicks(s, this.elg), a = s = s + i.globals.gridWidth / e + .3;
						...
						return n(t, [{
							...
							value: function (t, e) {
								var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 10,
									...
									r = this.w,
									o = Math.abs(e - t);
								if ("dataPoints" === (i = this._adjustTicksForSmallRange(i, a, o)) && (i = r.globals.dataPoints - 1), t === Number.MIN_VALUE && 0 === e || !m.isNumber(t) && !m.isNumber(e) || t === Number.MIN_VALUE && e === -Number.MAX_VALUE) {
									t = 0, e = i;
							...
							value: function (t) {
								...
								for (var d = t; d < a; d++) {
									...
									for (var g = 0; g < r.series[d].length; g++) {
										...
										})), m.isFloat(u) && (u = m.noExponents(u), r.yValueDecimal = Math.max(r.yValueDecimal, u.toString().split(".")[1].length)), n > h[d][g] && h[d][g] < 0 && (n = h[d][g])) : r.hasNullValues = !0
									}
								}
					...
					K = function () {
						function t(e) {
							r(this, t), this.ctx = e, this.w = e.w, this.documentEvent = m.bind(this.documentEvent, this)
						}
						return n(t, [{
								...
								return e.config.yaxis.map((function (r, o) {
									...
									if (!s.isYAxisHidden(o) && r.labels.show && void 0 !== r.labels.minWidth && (l = r.labels.minWidth), !s.isYAxisHidden(o) && r.labels.show && n.result.length) {
										...
										if (void 0 !== g && 0 !== g.length || (g = d), e.globals.isBarHorizontal) {
											...
											g = h(g = m.getLargestStringFromArr(p), {
												seriesIndex: o,
												dataPointIndex: -1,
												w: e
										...
										var f = new w(t.dCtx.ctx),
											...
											v = b;
										g !== u && (v = f.getTextRects(u, r.labels.style.fontSize, r.labels.style.fontFamily, x, !1)), i.push({
											width: (l > v.width || l > b.width ? l : v.width > b.width ? v.width : b.width) + a,
					...
					gt = function () {
						function t(e, i) {
							r(this, t), this.ctx = e, this.w = e.w, this.onLegendClick = this.onLegendClick.bind(this), this.onLegendHovered = this.onLegendHovered.bind(this), this.isBarsDistributed = "bar" === this.w.config.chart.type && this.w.config.plotOptions.bar.distributed && 1 === this.w.config.series.length, this.legendHelpers = new dt(this)
						}
						return n(t, [{
							key: "init",
							value: function () {
							...
							value: function () {
								...
								for (var o = e.globals.legendFormatter, n = e.config.legend.inverseOrder, l = n ? a.length - 1 : 0; n ? l >= 0 : l <= a.length - 1; n ? l-- : l++) {
									...
									var f = e.config.legend.markers.offsetX,
										...
										C = p.style;
									C.background = s[l], C.color = s[l], C.setProperty("background", s[l], "important"), e.config.legend.markers.fillColors && e.config.legend.markers.fillColors[l] && (C.background = e.config.legend.markers.fillColors[l]), void 0 !== e.globals.seriesColors[l] && (C.background = e.globals.seriesColors[l], C.color = e.globals.seriesColors[l]), C.height = Array.isArray(b) ? parseFloat(b[l]) + "px" : parseFloat(b) + "px", C.width = Array.isArray(v) ? parseFloat(v[l]) + "px" : parseFloat(v) + "px", C.left = (Array.isArray(f) ? parseFloat(f[l]) : parseFloat(f)) + "px", C.top = (Array.isArray(x) ? parseFloat(x[l]) : parseFloat(x)) + "px", C.borderWidth = Array.isArray(y) ? y[l] : y, C.borderColor = Array.isArray(k) ? k[l] : k, C.borderRadius = Array.isArray(A) ? parseFloat(A[l]) + "px" : parseFloat(A) + "px", e.config.legend.markers.customHTML && (Array.isArray(e.config.legend.markers.customHTML) ? e.config.legend.markers.customHTML[l] && (p.innerHTML = e.config.legend.markers.customHTML[l]()) : p.innerHTML = e.config.legend.markers.customHTML()), w.setAttrs(p, {
										rel: l + 1,
										"data:collapsed": c || d
									...
									T || (T = e.config.chart.foreColor), P.style.color = T, P.style.fontSize = parseFloat(e.config.legend.fontSize) + "px", P.style.fontWeight = e.config.legend.fontWeight, P.style.fontFamily = i || e.config.chart.fontFamily, w.setAttrs(P, {
										rel: l + 1,
										i: l,
					...
					ut = function () {
						...
						return n(t, [{
							...
							value: function (t) {
								...
								for (var i = 0; i < e.length; i++) this.elMenuItems.push(document.createElement("div")), this.elMenuItems[i].innerHTML = e[i].title, w.setAttrs(this.elMenuItems[i], {
							...
							value: function (t, e) {
								...
								if (void 0 !== t || void 0 !== e) {
									if (!(i.config.xaxis.convertedCatToNumeric && (t < 1 && (t = 1, e = i.globals.dataPoints), e - t < 2))) {
										...
										i.config.chart.zoom.autoScaleYaxis && (o = new $(this.ctx).autoScaleY(this.ctx, o, {
											xaxis: a
						...
						return n(i, [{
							...
							value: function (t) {
								var e, i = t.context,
									...
									g = r.clientY - o.top - l;
								return Math.abs(d + n) > s.globals.gridWidth ? d = s.globals.gridWidth - n : r.clientX - o.left < 0 && (d = n), n > r.clientX - o.left && (h = !0, d = Math.abs(d)), l > r.clientY - o.top && (c = !0, g = Math.abs(g)), e = "x" === a ? {
									x: h ? n - d : n,
									y: 0,
									width: d,
							...
							value: function (t) {
								...
								if (a.config.yaxis.forEach((function (t, e) {
									...
									v = {
										min: h,
										max: c
									}, "xy" !== i && "y" !== i || (y = m.clone(a.config.yaxis)).forEach((function (t, e) {
					...
					ft = function () {
						...
						return n(t, [{
							...
							value: function (t) {
								...
								})), r.globals.isXNumeric && (b = (v = this.closestInMultiArray(g, u, y, x)).index, p = v.j, null !== b && (y = r.globals.seriesXvalues[b], p = (v = this.closestInArray(g, y)).index)), r.globals.capturedSeriesIndex = null === b ? -1 : b, (!p || p < 1) && (p = 0), r.globals.isBarHorizontal ? r.globals.capturedDataPointIndex = f : r.globals.capturedDataPointIndex = p, {
									capturedSeries: b,
					...
					xt = function () {
						function t(e) {
							r(this, t), this.w = e.w, this.ctx = e.ctx, this.ttCtx = e, this.tooltipUtil = new ft(e)
						}
						return n(t, [{
							key: "drawSeriesTexts",
							value: function (t) {
							...
							value: function (t) {
								...
								for (var m = function (t, r) {
									...
									if (h.globals.axisCharts) {
										var y = function (t) {
											return m.yLbFormatter(h.globals.series[t][s], {
												series: h.globals.series,
												seriesIndex: t,
												dataPointIndex: s,
												w: h
										...
										n ? (m = i.getFormatters(v), x = i.getSeriesName({
											fn: m.yLbTitleFormatter,
											index: v,
											seriesIndex: a,
											j: s
										}), b = h.globals.colors[v], e = y(v), g(v) && (d = h.globals.seriesGoals[v][s].map((function (t) {
											return {
												attrs: t,
										...
										})))) : (l && l.target && l.target.getAttribute("fill") && (b = l.target.getAttribute("fill")), e = y(a), g(a) && Array.isArray(h.globals.seriesGoals[a][s]) && (d = h.globals.seriesGoals[a][s].map((function (t) {
											return {
												attrs: t,
												val: m.yLbFormatter(t.value, {
													seriesIndex: a,
									...
									null === s && (e = m.yLbFormatter(h.globals.series[a], c(c({}, h), {}, {
										seriesIndex: a,
										dataPointIndex: a
									}))), i.DOMHandling({
										i: a,
							...
							value: function (t) {
								...
								var d = r;
								return r = a.globals.isXNumeric && "datetime" === a.config.xaxis.type ? new _(this.ctx).xLabelFormat(a.globals.ttKeyFormatter, d, d, {
									i: void 0,
									dateFormatter: new D(this.ctx).formatDate,
									w: this.w
								}) : a.globals.isBarHorizontal ? a.globals.yLabelFormatters[0](d, h) : a.globals.xLabelFormatter(d, h), void 0 !== a.config.tooltip.x.formatter && (r = a.globals.ttKeyFormatter(d, h)), a.globals.seriesZ.length > 0 && a.globals.seriesZ[e].length > 0 && (n = c(a.globals.seriesZ[e][i], a)), o = "function" == typeof a.config.xaxis.tooltip.formatter ? a.globals.xaxisTooltipFormatter(d, h) : r, {
						...
						return n(t, [{
							...
							value: function (t) {
								...
								if (null !== i.xaxisTooltip) {
									...
									if (t -= i.xaxisTooltip.getBoundingClientRect().width / 2, !isNaN(t)) t += e.globals.translateX, a = new w(this.ctx).getTextRects(i.xaxisTooltipText.innerHTML), i.xaxisTooltipText.style.minWidth = a.width + "px", i.xaxisTooltip.style.left = t + "px", i.xaxisTooltip.style.top = s + "px"
								}
							}
						}, {
					...
					mt = function () {
						...
						return n(t, [{
							...
							value: function () {
								...
								a = x(a), t.config.chart.stacked && a.sort((function (t, e) {
					...
					wt = function () {
						...
						return n(t, [{
							...
							value: function (t) {
								...
								}, i.e = s, !i.tooltipUtil.hasBars() || r.globals.comboCharts || i.isBarShared || this.tConfig.onDatasetHover.highlightDataSeries && new F(e).toggleSeriesOnHover(s, s.target.parentNode), i.fixedTooltip && i.drawFixedTooltipRect(), r.globals.axisCharts ? i.axisChartsTooltips({
									e: s,
									opt: a,
					...
					kt = function (t) {
						...
						return n(i, [{
							...
							value: function (t, e) {
								var i = this,
									a = this.w;
								this.graphics = new w(this.ctx), this.bar = new H(this.ctx, this.xyRatios);
								...
								for (var o = this.graphics.group({
									...
									l = k.y, y = k.barHeight, d = k.yDivision, u = k.zeroW, n = k.x, w = k.barWidth, h = k.xDivision, g = k.zeroH, i.yArrj = [], i.yArrjF = [], i.yArrjVal = [], i.xArrj = [], i.xArrjF = [], i.xArrjVal = [], 1 === i.prevY.length && i.prevY[0].every((function (t) {
										return isNaN(t)
									...
									for (var A = 0; A < a.globals.dataPoints; A++) {
										var S = i.barHelpers.getStrokeWidth(s, A, x),
											...
											L = null;
										i.isHorizontal ? (L = i.drawStackedBarPaths(c(c({}, C), {}, {
											zeroW: u,
											barHeight: y,
											yDivision: d
										})), w = i.series[s][A] / i.invertedYRatio) : (L = i.drawStackedColumnPaths(c(c({}, C), {}, {
											xDivision: h,
											barWidth: w,
											zeroH: g
										})), y = i.series[s][A] / i.yRatio[i.yaxisIndex]), l = L.y, n = L.x, p.push(n), f.push(l);
					...
					At = function (t) {
						...
						return n(i, [{
							...
							value: function (t) {
								...
								var C = l.move(S, r),
									L = l.move(S + s / 2, y);
								return n.globals.previousPaths.length > 0 && (L = this.getPreviousPath(x, c, !0)), C = this.isBoxPlot ? [l.move(S, y) + l.line(S + s / 2, y) + l.line(S + s / 2, m) + l.line(S + s / 4, m) + l.line(S + s - s / 4, m) + l.line(S + s / 2, m) + l.line(S + s / 2, y) + l.line(S + s, y) + l.line(S + s, A) + l.line(S, A) + l.line(S, y + o / 2), l.move(S, A) + l.line(S + s, A) + l.line(S + s, k) + l.line(S + s / 2, k) + l.line(S + s / 2, v) + l.line(S + s - s / 4, v) + l.line(S + s / 4, v) + l.line(S + s / 2, v) + l.line(S + s / 2, k) + l.line(S, k) + l.line(S, A) + "z"] : [l.move(S, k) + l.line(S + s / 2, k) + l.line(S + s / 2, m) + l.line(S + s / 2, k) + l.line(S + s, k) + l.line(S + s, y) + l.line(S + s / 2, y) + l.line(S + s / 2, v) + l.line(S + s / 2, y) + l.line(S, y) + l.line(S, k - o / 2)], L += l.move(S, y), n.globals.isXNumeric || (i += a), {
									pathTo: C,
									pathFrom: L,
									x: i,
									y: k,
					...
					St = function () {
						...
						return n(t, [{
							...
							value: function (t, e, i, a) {
								...
								var l = n.color,
									h = new m;
								return s.config.plotOptions[t].enableShades && (l = "dark" === this.w.config.theme.mode ? m.hexToRgba(h.shadeColor(-1 * r, n.color), s.config.fill.opacity) : m.hexToRgba(h.shadeColor(r, n.color), s.config.fill.opacity)), {
									color: l,
									colorProps: n
								}
							}
					...
					Ct = function () {
						function t(e, i) {
							r(this, t), this.ctx = e, this.w = e.w, this.xRatio = i.xRatio, this.yRatio = i.yRatio, this.dynamicAnim = this.w.config.chart.animations.dynamicAnimation, this.helpers = new St(e), this.rectRadius = this.w.config.plotOptions.heatmap.radius, this.strokeWidth = this.w.config.stroke.show ? this.w.config.stroke.width : 0
						}
						return n(t, [{
							key: "draw",
							value: function (t) {
								...
								for (var h = n ? 0 : l.length - 1; n ? h < l.length : h >= 0; n ? h++ : h--) {
									...
									for (var g = 0, u = e.config.plotOptions.heatmap.shadeIntensity, p = 0; p < l[h].length; p++) {
										var f = this.helpers.getShadeColor(e.config.chart.type, h, p, this.negRange),
											x = f.color,
											b = f.colorProps;
										"image" === e.config.fill.type && (x = new z(this.ctx).fillPath({
											seriesNumber: h,
											dataPointIndex: p,
						...
						return n(t, [{
							...
							value: function (t) {
								...
								if (i.globals.dataChanged) {
									for (var c, d = 0, g = 0; g < i.globals.previousPaths.length; g++) d += m.negToZero(i.globals.previousPaths[g]);
									for (var u = 0; u < i.globals.previousPaths.length; u++) c = this.fullAngle * m.negToZero(i.globals.previousPaths[u]) / d, this.prevSectorAngleArr.push(c)
								}
								...
								if (this.sliceLabels.forEach((function (t) {
									...
									transform: "translate(".concat(b, ", ").concat(v, ") scale(").concat(p, ")")
							...
							value: function (t) {
								...
								if (this.yaxisLabels = this.graphics.group({
									...
									for (var x = 0; x < h.linePathsTo.length; x++) {
										var b = e.graphics.renderPaths(c(c({}, d), {}, {
										...
										var v = a.fillPath({
											...
											w = e.graphics.renderPaths(c(c({}, d), {}, {
						...
						return n(i, [{
							...
							value: function (t) {
								...
								for (var f = p ? t.series.length - 1 : 0; p ? f >= 0 : f < t.series.length; p ? f-- : f++) {
									...
									s.setSelectionFilter(T, 0, f), this.addListeners(T, this.radialDataLabels), x.add(T), T.attr({
										index: 0,
										j: f
									});
									var I = 0;
					...
					It = function () {
						...
						return n(t, [{
							...
							value: function (t) {
								...
								if ("area" === e)
									for (var p = n.fillPath({
										seriesNumber: i
									}), f = 0; f < s.areaPaths.length; f++) {
										var x = o.renderPaths(c(c({}, u), {}, {
								...
								if (r.config.stroke.show && !this.pointsChart) {
									...
									for (var m = 0; m < s.linePaths.length; m++) {
										...
										if (this.elSeries.add(y), l.count > 0) {
											...
											k.node.setAttribute("stroke-dasharray", l.dashArray), l.strokeWidth && k.node.setAttribute("stroke-width", l.strokeWidth), this.elSeries.add(k), k.attr("clip-path", "url(#forecastMask".concat(r.globals.cuid, ")")), y.attr("clip-path", "url(#nonForecastMask".concat(r.globals.cuid, ")"))
										}
									}
								}
							}
							...
							value: function (t) {
								for (var e = t.series, i = t.realIndex, a = t.i, s = t.x, r = t.y, o = t.pX, n = t.pY, l = t.pathsFrom, h = t.linePaths, c = t.areaPaths, d = t.seriesIndex, g = t.lineYPosition, u = t.xArrj, p = t.yArrj, f = this.w, x = new w(this.ctx), b = this.yRatio, v = l.prevY, y = l.linePath, k = l.areaPath, A = l.pathFromLine, S = l.pathFromArea, C = m.isNumber(f.globals.minYArr[i]) ? f.globals.minYArr[i] : f.globals.minY, L = f.globals.dataPoints > 1 ? f.globals.dataPoints - 1 : f.globals.dataPoints, P = 0; P < L; P++) {
									...
									c = I.areaPaths, h = I.linePaths, o = I.pX, n = I.pY, k = I.areaPath, y = I.linePath, this.appendPathFrom && (A += x.line(s, this.zeroY), S += x.line(s, this.zeroY)), this.handleNullDataPoints(e, z, a, P, i), this._handleMarkersAndLabels({
										pointsPos: z,
										series: e,
										x: s,
										y: r,
				...
				var Xt, Et, Yt = function () {
						function t(e, i) {
							r(this, t), this.ctx = e, this.w = e.w, this.strokeWidth = this.w.config.stroke.width, this.helpers = new St(e), this.dynamicAnim = this.w.config.chart.animations.dynamicAnimation, this.labels = []
						}
						return n(t, [{
							key: "draw",
							value: function (t) {
						...
						return n(t, [{
							...
							value: function (t, e) {
								...
								var y = this.timeScaleArray.map((function (t) {
									...
									return "month" === t.unit ? c(c({}, e), {}, {
										day: 1,
										value: t.value + 1
									}) : "day" === t.unit || "hour" === t.unit ? c(c({}, e), {}, {
										value: t.value
									}) : "minute" === t.unit ? c(c({}, e), {}, {
										value: t.value,
										minute: t.value
							...
							value: function (t) {
								var e = t.firstVal,
									...
									g = l,
									u = c(h, i, a);
								0 === e.minHour && 1 === e.minDate ? (d = 0, g = m.monthMod(e.minMonth), n = "month", h = e.minDate, r++) : 1 !== e.minDate && 0 === e.minHour && 0 === e.minMinute && (d = 0, l = e.minDate, g = l, u = c(h = l, i, a)), this.timeScaleArray.push({
									position: d,
									value: g,
									unit: n,
					...
					Rt = function () {
						...
						return n(t, [{
							...
							value: function (t, e) {
								...
								this.ctx.rangeBar = new N(this.ctx, e);
								...
								if (s.comboCharts) {
									if (o.series.length > 0 && x.push(g.draw(o.series, "area", o.i)), h.series.length > 0)
										...
										} else this.ctx.bar = new H(this.ctx, e), x.push(this.ctx.bar.draw(h.series, h.i));
								...
								case "area":
									...
									break;
								case "bar":
									a.chart.stacked ? x = new kt(this.ctx, e).draw(s.series) : (this.ctx.bar = new H(this.ctx, e), x = this.ctx.bar.draw(s.series));
									break;
								case "candlestick":
								case "boxPlot":
							...
							value: function () {
								...
								else t.axisCharts ? t.svgHeight = t.svgWidth / 1.61 : t.svgHeight = t.svgWidth / 1.2; if (t.svgWidth < 0 && (t.svgWidth = 0), t.svgHeight < 0 && (t.svgHeight = 0), w.setAttrs(t.dom.Paper.node, {
									width: t.svgWidth,
									height: t.svgHeight
								}), "%" !== s) {
							...
							value: function () {
								...
								e.dom.elLegendForeign && e.dom.elLegendForeign.setAttribute("height", l), e.dom.elWrap.style.height = l + "px", w.setAttrs(e.dom.Paper.node, {
									height: l
									...
									i.forEach((function (e) {
										...
										i.forEach((function (t) {
											...
											var o = i.w.config.yaxis.reduce((function (t, e, a) {
												return [].concat(x(t), [c(c({}, i.w.config.yaxis[a]), {}, {
													min: s[0].min,
													max: s[0].max
												})])
											}), []);
						...
						return n(t, [{
							...
							value: function (t, e) {
								...
								return r.globals.shouldAnimate = e, r.globals.dataChanged = !0, e && this.ctx.series.getPreviousPaths(), r.globals.axisCharts ? (0 === (i = t.map((function (t, e) {
									...
									data: []
								}]), r.config.series = i) : r.config.series = t.slice(), s && (r.globals.initialSeries = m.clone(r.config.series)), this.ctx.update()
							}
						}, {
							key: "_extendSeries",
							value: function (t, e) {
				...
				Xt = "undefined" != typeof window ? window : void 0, Et = function (t, e) {
					...
					}, r = "mlhvqtcsaz".split(""), o = 0, n = r.length; o < n; ++o) a[r[o]] = function (t) {
					...
					i.PathArray = function (t, e) {
						...
						parse: function (t) {
							...
							var r = [],
								...
								c = t.length;
							do {
								i.regex.isPathLetter.test(t[l]) ? (e = t[l], ++l) : "M" == e ? e = "L" : "m" == e && (e = "l"), r.push(a[e].call(null, t.slice(l, l += s[e.toUpperCase()]).map(parseFloat), o, n))
							} while (c > l);
							return r
						},
						bbox: function () {
						...
						create: function (t) {
							var e = f([1, 0, 0, 1, 0, 0]);
							t = null === t ? e : t instanceof i.Element ? t.matrixify() : "string" == typeof t ? f(t.split(i.regex.delimiter).map(parseFloat)) : 6 == arguments.length ? f([].slice.call(arguments)) : Array.isArray(t) ? f(t) : t && "object" === s(t) ? t : e;
				...
				function () {
					function t(t, s, r, o, n, l, h) {
						for (var c = t.slice(s, r || h), d = o.slice(n, l || h), g = 0, u = {
							...
							pos: [0, 0],
							start: [0, 0]
						}; c[g] = e.call(u, c[g]), d[g] = e.call(p, d[g]), c[g][0] != d[g][0] || "M" == c[g][0] || "A" == c[g][0] && (c[g][4] != d[g][4] || c[g][5] != d[g][5]) ? (Array.prototype.splice.apply(c, [g, 1].concat(a.call(u, c[g]))), Array.prototype.splice.apply(d, [g, 1].concat(a.call(p, d[g])))) : (c[g] = i.call(u, c[g]), d[g] = i.call(p, d[g])), ++g != c.length || g != d.length;) g == c.length && c.push(["C", u.pos[0], u.pos[1], u.pos[0], u.pos[1], u.pos[0], u.pos[1]]), g == d.length && d.push(["C", p.pos[0], p.pos[1], p.pos[0], p.pos[1], p.pos[0], p.pos[1]]);
						return {
							start: c,
							dest: d
						}
				...
				var Dt = function () {
						...
						return n(t, [{
							key: "initModules",
							value: function () {
								this.ctx.publicMethods = ["updateOptions", "updateSeries", "appendData", "appendSeries", "toggleSeries", "showSeries", "hideSeries", "setLocale", "resetSeries", "zoomX", "toggleDataPointSelection", "dataURI", "addXaxisAnnotation", "addYaxisAnnotation", "addPointAnnotation", "clearAnnotations", "removeAnnotation", "paper", "destroy"], this.ctx.eventList = ["click", "mousedown", "mousemove", "mouseleave", "touchstart", "touchmove", "touchleave", "mouseup", "touchend"], this.ctx.animations = new v(this.ctx), this.ctx.axes = new et(this.ctx), this.ctx.core = new Rt(this.ctx.el, this.ctx), this.ctx.config = new W({}), this.ctx.data = new G(this.ctx), this.ctx.grid = new Z(this.ctx), this.ctx.graphics = new w(this.ctx), this.ctx.coreUtils = new S(this.ctx), this.ctx.crosshairs = new it(this.ctx), this.ctx.events = new K(this.ctx), this.ctx.exports = new U(this.ctx), this.ctx.localization = new tt(this.ctx), this.ctx.options = new T, this.ctx.responsive = new at(this.ctx), this.ctx.series = new F(this.ctx), this.ctx.theme = new st(this.ctx), this.ctx.formatters = new _(this.ctx), this.ctx.titleSubtitle = new rt(this.ctx), this.ctx.legend = new gt(this.ctx), this.ctx.toolbar = new ut(this.ctx), this.ctx.dimensions = new ct(this.ctx), this.ctx.updateHelpers = new Ht(this.ctx), this.ctx.zoomPanSelection = new pt(this.ctx), this.ctx.w.globals.tooltip = new wt(this.ctx)
							}
						}]), t
					}(),
					Nt = function () {
					...
					Ot = function () {
						...
						return n(t, [{
							...
							value: function (t, e) {
								...
								var a = this.w.globals;
								if (a.noData = !1, a.animationEnded = !1, this.responsive.checkResponsiveConfig(e), i.config.xaxis.convertedCatToNumeric && new O(i.config).convertCatToNumericXaxis(i.config, this.ctx), null === this.el) return a.animationEnded = !0, null;
							...
							value: function () {
								...
								t && Apex._chartInstances.forEach((function (e, i) {
									e.id === m.escapeString(t) && Apex._chartInstances.splice(i, 1)
	...
	function i(a) {
		...
		return t[a](r, r.exports, i), r.exports
	}(() => {
		function t(t, e, i) {
			return e in t ? Object.defineProperty(t, e, {
				value: i,
		...
		$((function () {
			...
			new n(document.querySelector("#bar"), {
				chart: {
					height: 249,
					responsive: "true",
					type: "bar",
			...
			new n(document.querySelector("#spark1"), l).render(), new n(document.querySelector("#spark2"), h).render(), new n(document.querySelector("#spark3"), c).render(), new n(document.querySelector("#spark4"), d).render(), new n(document.querySelector("#spark5"), g).render();
			var u = {
				chart: {
					width: 200,
					height: 225,
			...
			new n(document.querySelector("#chart"), u).render(), $("#vmap2").vectorMap({
				map: "usa_en",
				showTooltip: !0,
				backgroundColor: "#fff",
				color: "#60adff",
				...
				borderColor: "#fff",
				hoverOpacity: .85
			}), $(".resp-tabs-list .index-valex").addClass("active"), $(".second-sidemenu .index-valex").addClass("resp-tab-content-active")
		}))
	})()
})();