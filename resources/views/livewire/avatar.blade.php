...
@section('content')
							...
							<div class="card-body">
								...
								<div class="text-wrap">
									...
									<ul class="nav nav-tabs html-source" id="html-source-code" role="tablist">
										<li class="nav-item">
											<a class="nav-link active me-1 html-code" id="html-code1"
												data-bs-toggle="tab" href="#html-code1" role="tab"
												aria-controls="html-code1" aria-selected="true"><i
													class="fab fa-html5 text-orange me-2"></i>HTML</a>
										</li>
									</ul>
									<!-- Prism Precode -->
									<figure class="highlight clip-widget" id="avatar1">
										<pre><code class="language-markup"><script type="html-dashlead/script"><div class="demo-avatar-group">
		<div class="main-img-user avatar-xs">
		...
		<div class="main-img-user avatar-xxl d-none d-sm-block">
			<img alt="avatar" class="rounded-circle" src="{{asset('assets/img/faces/8.jpg')}}">
										...
										<div class="clipboard-icon" data-clipboard-target="#avatar1"><i
		...
		<div class="main-img-user avatar-md">
			<img alt="avatar" class="radius" src="{{asset('assets/img/faces/6.jpg')}}">
										...
										<div class="clipboard-icon" data-clipboard-target="#avatar2"><i
												class="las la-clipboard"></i></div>
									</figure>
									<!-- End Prism Precode -->
								</div>
							...
							<div class="card-body">
								...
								<div class="text-wrap">
									...
									<figure class="highlight clip-widget" id="avatar3">
										<pre><code class="language-markup"><script type="html-dashlead/script"><div class="demo-avatar-group avatar-list">
		<div class="avatar avatar-xs bg-primary rounded-circle">
			A
		</div>
		<div class="avatar avatar-sm bg-secondary rounded-circle">
		...
		<div class="avatar avatar-xxl d-none d-sm-flex bg-pink rounded-circle">
			NB
										...
										<div class="clipboard-icon" data-clipboard-target="#avatar3"><i
												class="las la-clipboard"></i></div>
									</figure>
									<!-- End Prism Precode -->
								</div>
							...
							<div class="card-body">
								...
								<div class="text-wrap">
									...
									<figure class="highlight clip-widget" id="avatar4">
										<pre><code class="language-markup"><script type="html-dashlead/script"><div class="demo-avatar-group">
		<div class="main-avatar avatar online">
			<img alt="avatar" class="rounded-circle avatar" src="{{asset('assets/img/faces/9.jpg')}}">
		</div>
		<div class="main-avatar avatar-md offline">
			eb
		</div>
	</div></script></code></pre>
										<div class="clipboard-icon" data-clipboard-target="#avatar4"><i
												class="las la-clipboard"></i></div>
									</figure>
									<!-- End Prism Precode -->
								</div>
