					...
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Elements</h4><span
								class="text-muted mt-1 tx-13 ms-2 mb-0">/ Progress</span>
						</div>
					</div>
							...
							<div class="card-body">
								...
								<div class="text-wrap">
									...
									<figure class="highlight clip-widget" id="progress01">
										<pre><code class="language-markup"><script type="html-dashlead/script"><div class="progress mg-b-20">
							...
							<div class="card-body">
								...
								<div class="text-wrap">
									...
									<figure class="highlight clip-widget" id="progress55">
										<pre><code class="language-markup"><script type="html-dashlead/script"><div class="progress progress-style ht-5 mb-4">
							...
							<div class="card-body">
								...
								<div class="text-wrap">
									...
									<figure class="highlight clip-widget" id="progress03">
										<pre><code class="language-markup"><script type="html-dashlead/script"><div class="progress mg-b-10">
