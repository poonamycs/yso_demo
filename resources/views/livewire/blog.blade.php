						...
						<div class="col-xl-4 col-md-4">
							<div class="card custom-card">
								...
								<div class="card-body">
									...
									<a class="" href="{{url('search')}}">Read More<i class="fe fe-arrow-right ms-1"></i></a>
								</div>
							 </div>
						</div>
						<div class="col-xl-4 col-md-4">
						...
						<div class="col-xl-4 col-md-4">
							<div class="card custom-card">
								...
								<div class="card-body">
									<h4 class="card-title">Blog Title</h4>
									<p class="card-text">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa. </p>
									<a class="btn ripple btn-primary" href="{{url('search')}}">Read More<i class="fe fe-arrow-right ms-1"></i></a>
								</div>
							 </div>
						</div>
						<div class="col-xl-4 col-md-4">
								...
								<div class="card-body d-flex flex-column">
									...
									<div class="d-flex align-items-center pt-3 mt-auto">
										<div class="main-img-user avatar-sm me-3">
											<img src="{{asset('assets/img/faces//1.jpg')}}" class="w-10 rounded-circle" alt="avatar-img">
										</div>
										<div>
						...
						<div class="col-lg-6">
							<div class="card card-aside custom-card">
								<div class="card-body d-flex flex-column">
									...
									<div class="d-flex align-items-center pt-3 mt-auto">
										<div class="main-img-user avatar-sm me-3">
											<img src="{{asset('assets/img/faces//2.jpg')}}" class="w-10 rounded-circle" alt="avatar-img">
										</div>
										<div>
											<a href="" class="text-default">Alica Nestle</a>
											<small class="d-block text-muted">15 minutes ago</small>
