						...
						<div class="row row-sm">
								...
								<div class="card mg-b-20">
									<div class="card-body d-flex p-3">
										...
										<div class="ms-auto"><a class="d-block tx-20" data-bs-placement="top"
												data-bs-toggle="tooltip" title="Add New User" href="#"><i
							...
							<div class="col-xl-4 col-md-6">
								<div class="card mg-b-20">
									...
									<div class="card-footer ">
										...
										<a class="btn btn-outline-primary ms-auto float-end" href="#"
							...
							<div class="col-xl-4 col-md-6">
								<div class="card mg-b-20">
									...
									<div class="card-footer ">
										<a class="btn btn-primary" href="#" data-bs-placement="top"
							...
							<div class="col-xl-4 col-md-6">
								<div class="card mg-b-20 mg-lg-b-0">
									...
									<div class="card-footer ">
										<a class="btn btn-primary disabled" href="#" data-bs-placement="top"
											data-bs-toggle="tooltip" title="Assign Task">Assign</a>
										<a class="btn btn-outline-primary ms-auto float-end" href="#"
											data-bs-placement="top" data-bs-toggle="tooltip" title="View Task">View
											All</a>
