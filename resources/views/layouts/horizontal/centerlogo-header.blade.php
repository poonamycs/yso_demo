			...
			<div class="main-header nav nav-item hor-header top-header">
				<div class="container">
					...
					<a class="header-brand header-brand2 d-none d-lg-block" href="{{url('dashboard')}}">
						<img src="{{asset('assets/img/brand/logo-white.png')}}" class="desktop-dark">
						<img src="{{asset('assets/img/brand/logo.png')}}" class="desktop-logo">
						<img src="{{asset('assets/img/brand/favicon.png')}}" class="desktop-logo-1">
						<img src="{{asset('assets/img/brand/favicon-white.png')}}" class="desktop-logo-dark">
						...
						<ul class="nav">
							<li class="">
								<div class="dropdown  nav-itemd-none d-md-flex">
									<a href="#" class="d-flex  nav-item nav-link pr-0 country-flag1" data-bs-toggle="dropdown" aria-expanded="false">
