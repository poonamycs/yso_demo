...
<div class="breadcrumb-header justify-content-between">
	<div class="my-auto">
		<div class="d-flex">
			<h4 class="content-title mb-0 my-auto">Elements</h4><span class="text-muted mt-1 tx-13 ms-2 mb-0">/ Tabs</span>
		</div>
	</div>
			...
			<div class="card-body">
				...
				<div class="text-wrap">
					...
					<ul class="nav nav-tabs html-source" id="html-source-code" role="tablist">
						<li class="nav-item">
							<a class="nav-link active me-1 html-code" id="html-code"
...
<!-- Tabs -->
<ul class="nav panel-tabs main-nav-line">
<li><a href="#tab1" class="nav-link active" data-bs-toggle="tab">Tab 01</a></li>
<li><a href="#tab2" class="nav-link" data-bs-toggle="tab">Tab 02</a></li>
<li><a href="#tab3" class="nav-link" data-bs-toggle="tab">Tab 03</a></li>
</ul>
</div>
</div>
...
<p class="mb-0">similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor repellendus.</p>
						...
						<div class="clipboard-icon" data-clipboard-target="#tabs"><i
			...
			<div class="card-body">
				...
				<div class="text-wrap">
								...
								<div class="tabs-menu ">
									...
									<ul class="nav panel-tabs">
										<li class=""><a href="#tab11" class="active"
												data-bs-toggle="tab"><i class="fa fa-laptop"></i> Tab
												Style 01</a></li>
										<li><a href="#tab12" data-bs-toggle="tab"><i
													class="fa fa-cube"></i> Tab Style 02</a></li>
										<li><a href="#tab13" data-bs-toggle="tab"><i
													class="fa fa-cogs"></i> Tab Style 03</a></li>
										<li><a href="#tab14" data-bs-toggle="tab"><i
													class="fa fa-tasks"></i> Tab Style 04</a></li>
									</ul>
								</div>
							</div>
					...
					<figure class="highlight mb-0" id="element3">
						<pre><code class="language-markup mb-0"><script type="prismsmix/javascript">
							<div class="panel panel-primary tabs-style-3">
								<div class="tab-menu-heading">
								<div class="tabs-menu ">
								<!-- Tabs -->
								<ul class="nav panel-tabs">
									<li class=""><a href="#tab11" class="active" data-bs-toggle="tab"><i class="fa fa-laptop"></i> Tab Style 01</a></li>
									<li><a href="#tab12" data-bs-toggle="tab"><i class="fa fa-cube"></i> Tab Style 02</a></li>
									<li><a href="#tab13" data-bs-toggle="tab"><i class="fa fa-cogs"></i> Tab Style 03</a></li>
									<li><a href="#tab14" data-bs-toggle="tab"><i class="fa fa-tasks"></i> Tab Style 04</a></li>
								</ul>
								</div>
								</div>
								<div class="panel-body tabs-menu-body">
											...
											<ul class="nav panel-tabs me-3">
												<li class=""><a href="#tab21" class="active"
														data-bs-toggle="tab"><i
															class="fa fa-laptop"></i> Tab Style 01</a>
												</li>
												<li><a href="#tab22" data-bs-toggle="tab"><i
															class="fa fa-cube"></i> Tab Style 02</a>
												</li>
												<li><a href="#tab23" data-bs-toggle="tab"><i
															class="fa fa-cogs"></i> Tab Style 03</a>
												</li>
												<li><a href="#tab24" data-bs-toggle="tab"><i
															class="fa fa-tasks"></i> Tab Style 04</a>
												</li>
											</ul>
										</div>
									</div>
...
<div class="tab-menu-heading">
	<div class="tabs-menu ">
		<!-- Tabs -->
		<ul class="nav panel-tabs">
			<li class=""><a href="#tab21" class="active" data-bs-toggle="tab"><i class="fa fa-laptop"></i> Tab Style 01</a></li>
			<li><a href="#tab22" data-bs-toggle="tab"><i class="fa fa-cube"></i> Tab Style 02</a></li>
			<li><a href="#tab23" data-bs-toggle="tab"><i class="fa fa-cogs"></i> Tab Style 03</a></li>
			<li><a href="#tab24" data-bs-toggle="tab"><i class="fa fa-tasks"></i> Tab Style 04</a></li>
		</ul>
	</div>
</div>
</div>
		...
		<div class="card-body">
			...
			<div class="text-wrap">
				...
				<ul class="nav nav-tabs html-source" id="html-source-code5" role="tablist">
					<li class="nav-item">
						<a class="nav-link active me-1 html-code" id="js-tab" data-bs-toggle="tab"
							href="#default-tab" role="tab" aria-controls="default-tab"
							aria-selected="true"><i class="fab fa-html5 text-orange me-2"></i>HTML</a>
						<a class="nav-link me-1 html-code" id="js-tab1" data-bs-toggle="tab"
							href="#default-tab1" role="tab" aria-controls="default-tab1"
							aria-selected="true"><i class="fab fa-node-js text-info me-2"></i>JS</a>
						<a class="nav-link me-1 html-code" id="js-tab2" data-bs-toggle="tab"
...
src="{{asset('assets/plugins/tabs/jquery.multipurpose_tabcontent.js')}}"</script></code></pre>
							<div class="clipboard-icon" data-clipboard-target="#element5"><i
									class="las la-clipboard"></i></div>
						</figure>
					</div>
...
src="{{asset('assets/js/tabs.js')}}"</script></code></pre>
							<div class="clipboard-icon" data-clipboard-target="#element5"><i
									class="las la-clipboard"></i></div>
						</figure>
					</div>
