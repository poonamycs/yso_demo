								...
								<div class="card-body">
									...
									<div class="text-wrap">
										...
										<ul class="nav nav-tabs html-source" id="html-source-code" role="tablist">
											<li class="nav-item">
												<a class="nav-link active html-code" id="html-code" data-bs-toggle="tab" href="#html-code" role="tab" aria-controls="html-code" aria-selected="true"><i class="fab fa-html5 text-orange me-2"></i>HTML</a>
											</li>
										</ul>
	<!-- Prism Precode -->
									...
									<div class="text-wrap">
										<div class="example">
											<div class="dropdown dropup">
												<button aria-expanded="false" aria-haspopup="true" class="btn ripple btn-secondary" data-bs-toggle="dropdown" type="button">Dropup Menu <i class="fas fa-caret-down ms-1"></i></button>
												<div class="dropdown-menu tx-13">
													<a class="dropdown-item" href="#">Action</a>
													<a class="dropdown-item" href="#">Another action</a>
													<a class="dropdown-item" href="#">Something else here</a>
										...
										<ul class="nav nav-tabs html-source" id="html-source-code2" role="tablist">
											<li class="nav-item">
												<a class="nav-link active html-code" id="html-code2" data-bs-toggle="tab" href="#html-code2" role="tab" aria-controls="html-code2" aria-selected="true"><i class="fab fa-html5 text-orange me-2"></i>HTML</a>
											</li>
										</ul>
	<!-- Prism Precode -->
	...
	<!-- End Prism Precode -->
						...
						<div class="col-lg-12 col-md-12">
							<div class="card custom-card" id="right">
								<div class="card-body">
									<div>
										<h6 class="card-title mb-1">Dropleft & Dropright</h6>
									...
									<div class="text-wrap">
											...
											<div class="row row-xs custom-cls-res">
												<div class="col-sm-6 col-md-3 mg-t-10 mg-sm-t-0">
													<div class="dropdown dropend">
														<button aria-expanded="false" aria-haspopup="true" class="btn ripple btn-info" data-bs-toggle="dropdown" id="dropendMenuButton" type="button">Dropright Menu<i class="fas fa-caret-right ms-1"></i></button>
												...
												<div class="col-sm-6 col-md-3">
													<div class="dropdown dropstart">
														<button aria-expanded="false" aria-haspopup="true" class="btn ripple btn-danger dropdown-toggle-left" data-bs-toggle="dropdown" id="dropstartMenuButton" type="button">Dropleft Menu</i></button>
										...
										<ul class="nav nav-tabs html-source" id="html-source-code3" role="tablist">
											<li class="nav-item">
												<a class="nav-link active html-code" id="html-code3" data-bs-toggle="tab" href="#html-code3" role="tab" aria-controls="html-code3" aria-selected="true"><i class="fab fa-html5 text-orange me-2"></i>HTML</a>
											</li>
										</ul>
	<!-- Prism Precode -->
								...
								<div class="card-body">
									...
									<div class="text-wrap">
										...
										<ul class="nav nav-tabs html-source" id="html-source-code4" role="tablist">
											<li class="nav-item">
												<a class="nav-link active html-code" id="html-code4" data-bs-toggle="tab" href="#html-code4" role="tab" aria-controls="html-code4" aria-selected="true"><i class="fab fa-html5 text-orange me-2"></i>HTML</a>
											</li>
										</ul>
	<!-- Prism Precode -->
								...
								<div class="card-body">
									...
									<div class="text-wrap">
										...
										<ul class="nav nav-tabs html-source" id="html-source-code5" role="tablist">
											<li class="nav-item">
												<a class="nav-link active html-code" id="html-code5" data-bs-toggle="tab" href="#html-code5" role="tab" aria-controls="html-code5" aria-selected="true"><i class="fab fa-html5 text-orange me-2"></i>HTML</a>
											</li>
										</ul>
	<!-- Prism Precode -->
								...
								<div class="card-body">
									...
									<div class="text-wrap">
										...
										<ul class="nav nav-tabs html-source" id="html-source-code6" role="tablist">
											<li class="nav-item">
												<a class="nav-link active html-code" id="html-code6" data-bs-toggle="tab" href="#html-code6" role="tab" aria-controls="html-code6" aria-selected="true"><i class="fab fa-html5 text-orange me-2"></i>HTML</a>
											</li>
										</ul>
	<!-- Prism Precode -->
								...
								<div class="card-body">
									...
									<div class="text-wrap">
										...
										<ul class="nav nav-tabs html-source" id="html-source-code7" role="tablist">
											<li class="nav-item">
												<a class="nav-link active html-code" id="html-code7" data-bs-toggle="tab" href="#html-code7" role="tab" aria-controls="html-code7" aria-selected="true"><i class="fab fa-html5 text-orange me-2"></i>HTML</a>
											</li>
										</ul>
	<!-- Prism Precode -->
