...
@section('content')
					...
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Elements</h4><span
								class="text-muted mt-1 tx-13 ms-2 mb-0">/ Alerts</span>
						</div>
					</div>
	...
	<div class="alert alert-danger mg-b-0" role="alert">
		...
		<strong>Oh snap!</strong> Change a few things up and try submitting again.
										...
										<div class="clipboard-icon" data-clipboard-target="#alert1"><i
							...
							<div class="card-footer">
								<table class="table main-table-reference mt-0 mb-0">
									...
									<tbody>
										<tr>
											<td><code class="pd-0 bg-transparent">class="alert alert-[value]"</code>
											</td>
							...
							<div class="card-body">
								...
								<div class="text-wrap">
									...
									<ul class="nav nav-tabs html-source" id="html-source-code2" role="tablist">
										<li class="nav-item">
											<a class="nav-link active html-code me-1" id="html-code2"
							...
							<div class="card-footer">
								<table class="table main-table-reference mt-0 mb-0">
									...
									<tbody>
										<tr>
											<td><code
													class="pd-0 bg-transparent">class="alert alert-outline-[value]"</code>
											</td>
											<td>success | info | warning | danger</td>
										</tr>
									</tbody>
	...
	<div class="alert alert-solid-danger mg-b-0" role="alert">
		...
		<strong>Oh snap!</strong> Change a few things up and try submitting again.
										...
										<div class="clipboard-icon" data-clipboard-target="#alert2"><i
												class="las la-clipboard"></i></div>
									</figure>
									<!-- End Prism Precode -->
								</div>
								...
								<div class="text-wrap">
									<div class="example">
										<div class="alert alert-primary" role="alert">
											This is a primary alert with <a href="#" class="alert-link">an example
										...
										<div class="alert alert-danger" role="alert">
											This is a danger alert with <a href="#" class="alert-link">an example
												link</a>. Give it a click if you like.
										</div>
										<div class="alert alert-warning" role="alert">
											This is a warning alert with <a href="#" class="alert-link">an example
												link</a>. Give it a click if you like.
										</div>
										<div class="alert alert-info" role="alert">
											This is a info alert with <a href="#" class="alert-link">an example
												link</a>. Give it a click if you like.
										</div>
										<div class="alert alert-light" role="alert">
											This is a light alert with <a href="#" class="alert-link">an example
												link</a>. Give it a click if you like.
										</div>
										<div class="alert alert-dark mb-0" role="alert">
											This is a dark alert with <a href="#" class="alert-link">an example
												link</a>. Give it a click if you like.
										</div>
									</div>
									...
									<figure class="highlight clip-widget" id="alert4">
										<pre><code class="language-markup"><script type="html-dashlead/script"><div class="alert alert-primary" role="alert">
	...
	<div class="alert alert-dark mb-0" role="alert">
	  This is a dark alert with <a href="#" class="alert-link">an example link</a>. Give it a click if you like.
										...
										<div class="clipboard-icon" data-clipboard-target="#alert4"><i
												class="las la-clipboard"></i></div>
									</figure>
									<!-- End Prism Precode -->
								</div>
							...
							<div class="card-body">
								...
								<div class="text-wrap">
									...
									<figure class="highlight clip-widget" id="alert5">
										<pre><code class="language-markup"><script type="html-dashlead/script"><div class="alert alert-success mb-0" role="alert">
	  <h4 class="alert-heading">Well done!</h4>
	  ...
	  <p class="mb-0">Whenever you need to, be sure to use margin utilities to keep things nice and tidy.</p>
										...
										<div class="clipboard-icon" data-clipboard-target="#alert5"><i
												class="las la-clipboard"></i></div>
									</figure>
									<!-- End Prism Precode -->
								</div>
							...
							<div class="card-body">
								...
								<div class="text-wrap">
									...
									<ul class="nav nav-tabs html-source" id="html-source-code6" role="tablist">
										<li class="nav-item">
											<a class="nav-link active me-1 html-code" id="html-code6"
									...
									<figure class="highlight clip-widget" id="alert6">
										<pre><code class="language-markup"><script type="html-dashlead/script"><div class="alert alert-warning alert-dismissible fade show" role="alert">
	...
	<div class="alert alert-info alert-dismissible fade show mb-0" role="alert">
	  ...
	  <button type="button" class="close" data-bs-dismiss="alert" aria-label="Close">
		<span aria-hidden="true">&times;</span>
										...
										<div class="clipboard-icon" data-clipboard-target="#alert6"><i
												class="las la-clipboard"></i></div>
									</figure>
									<!-- End Prism Precode -->
								</div>
							...
							<div class="card-body">
								...
								<div class="text-wrap">
									...
									<ul class="nav nav-tabs html-source" id="html-source-code7" role="tablist">
										<li class="nav-item">
											<a class="nav-link active me-1 html-code" id="html-code7"
									...
									<figure class="highlight clip-widget" id="alert7">
										<pre><code class="language-markup"><script type="html-dashlead/script"><div class="alert alert-default" role="alert">
		<span class="alert-inner--icon"><i class="fe fe-download"></i></span>
	...
	<div class="alert alert-danger mb-0" role="alert">
		...
		<span class="alert-inner--text"><strong>Danger!</strong> This is a warning alert—check it out that has an icon too!</span>
										...
										<div class="clipboard-icon" data-clipboard-target="#alert7"><i
												class="las la-clipboard"></i></div>
									</figure>
									<!-- End Prism Precode -->
								</div>
							...
							<div class="card-body">
								...
								<div class="text-wrap">
									...
									<ul class="nav nav-tabs html-source" id="html-source-code8" role="tablist">
										<li class="nav-item">
											<a class="nav-link active me-1 html-code" id="html-code8"
									...
									<figure class="highlight clip-widget" id="alert8">
										<pre><code class="language-markup"><script type="html-dashlead/script"><div class="alert alert-default alert-dismissible fade show" role="alert">
		<span class="alert-inner--icon"><i class="fe fe-download"></i></span>
	...
	<div class="alert alert-danger alert-dismissible fade show mb-0" role="alert">
		...
		<button type="button" class="close" data-bs-dismiss="alert" aria-label="Close">
			<span aria-hidden="true">×</span>
										...
										<div class="clipboard-icon" data-clipboard-target="#alert8"><i
												class="las la-clipboard"></i></div>
									</figure>
									<!-- End Prism Precode -->
								</div>
