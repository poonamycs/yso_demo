				...
				<div class="main-sidemenu">
					...
					<ul class="side-menu">
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li><a class="slide-item" href="{{url('products')}}">Products</a></li>
								<li><a class="slide-item" href="{{url('product-details')}}">Product-Details</a></li>
								<li><a class="slide-item" href="{{url('product-cart')}}">Cart</a></li>
							</ul>
						</li>
