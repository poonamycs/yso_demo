...
@section('content')
					...
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Elements</h4><span
								class="text-muted mt-1 tx-13 ms-2 mb-0">/ Media-object</span>
						</div>
					</div>
						...
						<div class="card" id="media-object">
							<div class="card-body">
								...
								<div class="text-wrap">
									...
									<!-- Prism Precode -->
									<figure class="highlight clip-widget" id="media-object01">
										<pre><code class="language-markup"><script type="html-dashlead/script"><div class="media d-block d-sm-flex">
		...
		<div class="media-body">
			...
			Lorem Ipsum generators on the Internet as necessary aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit
										...
										<div class="clipboard-icon" data-clipboard-target="#media-object01"><i
						...
						<div class="card" id="media-object2">
							<div class="card-body">
								...
								<div class="text-wrap">
									...
									<!-- Prism Precode -->
									<figure class="highlight clip-widget" id="media-object02">
										<pre><code class="language-markup"><script type="html-dashlead/script"><div class="media d-block d-sm-flex">
			...
			<div class="media d-block d-sm-flex mg-t-25">
				...
				<div class="media-body">
					...
					Lorem Ipsum generators on the Internet as necessary aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit
										...
										<div class="clipboard-icon" data-clipboard-target="#media-object02"><i
												class="las la-clipboard"></i></div>
									</figure>
									<!-- End Prism Precode -->
								</div>
						...
						<div class="card" id="media-object3">
							<div class="card-body">
								...
								<div class="text-wrap">
									<div class="example">
										<div class="media d-block d-sm-flex">
											<img alt=""
												...
												src="{{asset('assets/img/faces/14.jpg')}}">
											<div class="media-body">
												<h5 class="mg-b-5 tx-inverse tx-15">Media heading</h5>
												Lorem Ipsum generators on the Internet as necessary aut odit aut fugit,
												sed quia consequuntur magni dolores eos qui ratione voluptatem sequi
									...
									<!-- Prism Precode -->
									<figure class="highlight clip-widget" id="media-object03">
										<pre><code class="language-markup"><script type="html-dashlead/script"><div class="media d-block d-sm-flex">
		...
		<div class="media-body">
			...
			Lorem Ipsum generators on the Internet as necessary aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit Lorem Ipsum generators on the Internet as necessary aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit
										...
										<div class="clipboard-icon" data-clipboard-target="#media-object03"><i
												class="las la-clipboard"></i></div>
									</figure>
									<!-- End Prism Precode -->
								</div>
						...
						<div class="card" id="media-object4">
							<div class="card-body">
								...
								<div class="text-wrap">
									...
									<!-- Prism Precode -->
									<figure class="highlight clip-widget" id="media-object04">
										<pre><code class="language-markup"><script type="html-dashlead/script"><div class="media d-block d-sm-flex">
		<div class="media-body">
			<h5 class="mg-b-5 tx-inverse tx-15">Media heading</h5>
			Lorem Ipsum generators on the Internet as necessary aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit
		...
		<img alt="" class="main-img-user avatar-lg mg-sm-l-20 mg-t-20 mg-sm-t-0" src="{{asset('assets/img/faces/5.jpg')}}">
										...
										<div class="clipboard-icon" data-clipboard-target="#media-object04"><i
												class="las la-clipboard"></i></div>
									</figure>
									<!-- End Prism Precode -->
								</div>
						...
						<div class="card" id="media-object5">
							<div class="card-body">
								...
								<div class="text-wrap">
									...
									<!-- Prism Precode -->
									<figure class="highlight clip-widget" id="media-object05">
										<pre><code class="language-markup"><script type="html-dashlead/script"><ul class="list-unstyled mb-0">
		<li class="media d-block d-sm-flex">
		...
		<li class="media d-block d-sm-flex mg-t-25">
			<img alt="" class="main-img-user avatar-lg mg-sm-r-20 mg-b-20 mg-sm-b-0" src="{{asset('assets/img/faces/12.jp')}}g">
			<div class="media-body">
				<h5 class="mg-b-5 tx-inverse tx-15">Media heading</h5>
				Lorem Ipsum generators on the Internet as necessary aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit
			</div>
		...
		<li class="media d-block d-sm-flex mg-t-25">
			...
			<div class="media-body">
				...
				Lorem Ipsum generators on the Internet as necessary aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit
										...
										<div class="clipboard-icon" data-clipboard-target="#media-object05"><i
												class="las la-clipboard"></i></div>
									</figure>
									<!-- End Prism Precode -->
								</div>
