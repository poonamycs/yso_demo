...
<script src='http://fullcalendar.io/js/fullcalendar-2.1.1/fullcalendar.min.js'></script>
    ...
    $(function () {
        ...
        var oldEvent,
            ...
            myData = [{
                id: 4,
                start: '2023-03-10T10:30',
                end: '2023-03-10T11:30',
        ...
        function createAddPopup(elm) {
            ...
            popup.setOptions({
                headerText: 'New event',                // More info about headerText: https://docs.mobiscroll.com/5-22-2/eventcalendar#opt-headerText
                buttons: ['cancel', {                   // More info about buttons: https://docs.mobiscroll.com/5-22-2/eventcalendar#opt-buttons
                    ...
                    handler: function () {
                        calendar.updateEvent({
                            ...
                            start_date: tempEvent.start,
                            end_date: tempEvent.end,
