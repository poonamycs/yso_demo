...
@section('content')
	...
	<div><img alt="Responsive image" class="img-fluid" src="{{asset('assets/img/photos/1.jpg')}}"></div></script></code></pre>
	...
	<img alt="Responsive image" class="img-thumbnail wd-100p wd-sm-200" src="{{asset('assets/img/photos/1.jpg')}}"></script></code></pre>
							...
							<div class="text-wrap">
								<div class="example">
									<div class="bd pd-20 clearfix">
										...
										<img alt="" class="rounded float-sm-right wd-100p wd-sm-200 mg-t-10 mg-sm-t-0" src="{{asset('assets/img/photos/1.jpg')}}">
									</div>
								</div>
							</div>
