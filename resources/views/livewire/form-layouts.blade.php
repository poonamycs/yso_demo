...
@section('content')
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
								<h4 class="content-title mb-0 my-auto">Forms</h4><span class="text-muted mt-1 tx-13 ms-2 mb-0">/ Form-Layouts</span>
							</div>
						</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="main-dropdown-form-demo">
										<div class="mg-t-20">
											<button class="btn btn-main-primary pd-x-20" data-bs-toggle="dropdown">Live Example <i class="icon ion-ios-arrow-down mg-l-5 tx-12"></i></button>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="tx-center pd-y-20 bg-gray-200">
										<a class="btn btn-main-primary" data-bs-target="#modaldemo1" data-bs-toggle="modal" href="">View Live Demo</a>
									</div><!-- pd-y-30 -->
									<div class="modal">
